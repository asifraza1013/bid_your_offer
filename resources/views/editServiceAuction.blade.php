        ...
        <div class="card">
            <div class="row">
                <div class="col-12 p-4">
                    <form class="p-4 pt-0" action="{{ route('agent.service.auction.update') }}" method="POST"
                        enctype="multipart/form-data">
                        @csrf
                        <input type="hidden" name="id" value="{{$id}}">
                        <div class="container">
                            <div class="title">
                                <h4>Edit Agent Service auction</h4>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4 mt-4">
                                    ...
                                    <select class="form-select mb-0 auction_length" name="auction_length" required>
                                        <option value="30M" class="normal-length" {{ @$auction->auction_length == '30M' ? 'selected' : '' }}>30 Minutes</option>
                                        <option value="60M" class="normal-length" {{ @$auction->auction_length == '60M' ? 'selected' : '' }}>1 Hour</option>
                                        <option value="120M" class="normal-length" {{ @$auction->auction_length == '120M' ? 'selected' : '' }}>2 Hour</option>
                                        <option value="180M" class="normal-length" {{ @$auction->auction_length == '180M' ? 'selected' : '' }}>3 Hour</option>
                                        <option value="240M" class="normal-length" {{ @$auction->auction_length == '240M' ? 'selected' : '' }}>4 Hour</option>
                                        <option value="300M" class="normal-length" {{ @$auction->auction_length == '300M' ? 'selected' : '' }}>5 Hour</option>
                                        <option value="360M" class="normal-length" {{ @$auction->auction_length == '360M' ? 'selected' : '' }}>6 Hour</option>
                                        <option value="420M" class="normal-length" {{ @$auction->auction_length == '420M' ? 'selected' : '' }}>7 Hour</option>
                                        <option value="480M" class="normal-length" {{ @$auction->auction_length == '480M' ? 'selected' : '' }}>8 Hour</option>
                                        <option value="540M" class="normal-length" {{ @$auction->auction_length == '540M' ? 'selected' : '' }}>9 Hour</option>
                                        <option value="600M" class="normal-length" {{ @$auction->auction_length == '600M' ? 'selected' : '' }}>10 Hour</option>
                                        <option value="660M" class="normal-length" {{ @$auction->auction_length == '660M' ? 'selected' : '' }}>11 Hour</option>
                                        <option value="720M" class="normal-length" {{ @$auction->auction_length == '720M' ? 'selected' : '' }}>12 Hour</option>
                                ...
                                <div class="form-group col-md-4 mt-4">
                                    ...
                                    <select name="service_id" class="form-select">
                                        @foreach ($services as $service)
                                            <option value="{{$service->id}}" {{ @$auction->service_id==$service->id?"selected":"" }} >{{$service->name}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control" cols="30" rows="3" required>{{@$auction->description}}</textarea>
                                    ...
                                    <select name="city_id" class="form-select" placeholder="Select City"
                                        ...
                                        @foreach ($cities as $city)
                                            <option value="{{ $city->id }}"
                                                {{ @$auction->city_id == $city->id ? 'selected' : '' }}>{{ $city->name }}</option>
                                        @endforeach
                                    </select>
                                    ...
                                    <select name="county_id" class="form-select" placeholder="Select County"
                                        ...
                                        @foreach ($counties as $county)
                                            <option value="{{ $county->id }}"
                                                {{ @$auction->county_id == $county->id ? 'selected' : '' }}>{{ $county->name }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row">
                                <div class="form-group">
                                    ...
                                    <textarea name="public_notes" class="form-control" cols="30" rows="3">{{@$auction->public_notes}}</textarea>
                                </div>
                            </div>
                                ...
                                <div class="form-group col-md-4 mt-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control border-start-0 mb-0" name="min_price"
                                            min="0" required placeholder="0.00" value="{{ @$auction->min_price }}">
                                    </div>
                                ...
                                {{-- <div class="form-group col-md-4 mt-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control border-start-0 mb-0" name="min_price_percent"
                                            min="0" required placeholder="0.00" value="{{ @$auction->min_price_percent }}">
                                    </div>
                                ...
                                <div class="card-body p-2">
                                    <div class="row">
                                        <div class="form-group mt-4 col-md-4">
                                            ...
                                            <input type="text" name="agent_name" required class="form-control" value="{{@$auction->agent_name}}">
                                        </div>
                                        ...
                                        <div class="form-group mt-4 col-md-4">
                                            ...
                                            <input type="text" name="agent_brokerage" placeholder="" class="form-control"
                                                value="{{ @$auction->agent_brokerage }}" required />
                                        </div>
                                        ...
                                        <div class="form-group mt-4 col-md-4">
                                            ...
                                            <input type="text" name="agent_license_no" placeholder="" class="form-control"
                                                value="{{ @$auction->agent_license_no }}" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group mt-4 col-md-4">
                                            ...
                                            <input type="text" name="agent_phone" required class="form-control" value="{{@$auction->agent_phone}}">
                                        </div>
                                        ...
                                        <div class="form-group mt-4 col-md-4">
                                            ...
                                            <input type="text" name="agent_email" placeholder="" class="form-control"
                                                value="{{ @$auction->agent_email }}" required />
                                        </div>
                                        ...
                                        <div class="form-group mt-4 col-md-4">
                                            ...
                                            <input type="text" name="agent_mls_id" placeholder="" class="form-control"
                                                value="{{ @$auction->agent_mls_id }}" required />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card-body p-2">
                                    <div class="row">
                                        <div class="form-group mt-0 col-md-12">
                                            ...
                                            <textarea name="private_notes" class="form-control" cols="30" rows="3">{{@$auction->private_notes}}</textarea>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group mt-4 col-md-12">
                                            ...
                                            <textarea name="meeting_info" class="form-control" cols="30" rows="3" placeholder="(Buyer, Seller, inspector etc.) Include name, phone number and email address">{{@$auction->meeting_info?@$auction->meeting_info:"If agent needs to meet someone please provide the information on the person the agent needs to meet:
Full Name:
Phone:
Email:
...
Address where the agent needs to meet:"}}</textarea>
                                    ...
                                    <div class="row">
                                        <div class="form-group mt-4 col-md-4">
                                            ...
                                            <input type="text" name="address" class="form-control" value="{{@$auction->address}}">
                                        </div>
                                        ...
                                        <div class="form-group mt-4 col-md-4">
                                            ...
                                            <input type="text" name="mls_listing_link" placeholder="" class="form-control"
                                                value="{{ @$auction->mls_listing_link }}" />
                                        </div>
                                    </div>
                                </div>
                            </div>
