  ...
  <div class="container p-4">
    ...
    <div class="card m-4">
      ...
      <div class="card-body">
        ...
        <form class="p-4 pt-0 mainform" action="{{ route('tenant.add-counter-terms') }}" method="POST"
          enctype="multipart/form-data">
          @csrf

          <input type="hidden" name="tanantId" value="{{ $tenantId }}">
          @php
            $yes_or_nos = [
          ...
          <div class="wizard-step">
            ...
            @endphp
            <div class="form-group">
              <label class="fw-bold">Would the tenant be willing to pay a finder’s fee to the agent for their assistance
              ...
              <div class="form-group propFeeYes d-none">
                @php
                  $propFee = [
                ...
                @endphp
                <label class="fw-bold">What is the finder’s fee that the tenant is offering to pay the agent for their
                  assistance in finding a property?</label>
