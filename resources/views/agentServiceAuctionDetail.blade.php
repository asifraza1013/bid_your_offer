            ...
            <div class="col-sm-12 col-md-8 col-lg-8 leftCol">
                ...
                <div class="card description">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row" style="flex-wrap: wrap;">
                            <div class="col-md-6 col-6 pt-2 fw-bold">Name: {{ @$auction->agent_name }}</div>
                            ...
                            <div class="col-md-6 col-6 pt-2 fw-bold">Phone: {{ @$auction->agent_phone }}</div>
                            <div class="col-md-6 col-6 pt-2 fw-bold">Email: {{ @$auction->agent_email }}</div>
                        ...
                        <div class="col-md-6 col-6 pt-2 fw-bold">MLS ID: {{ @$auction->mls_id }}</div>
                        <div class="col-md-6 col-6 pt-2 fw-bold">MLS Listing Link:
                            @if(@$auction->mls_listing_link)
                            <a href="{{@$auction->mls_listing_link}}" target="_blank">{{ @$auction->mls_listing_link }}</a>
                            @endif
                        </div>
                        @endif
                        ...
                        <div class="row" style="flex-wrap: wrap;">
                            <p>{{ @$auction->contract_terms }}</p>
                        </div>
                        <hr>
                        <h4>Property Condition</h4>
                        <div class="row" style="flex-wrap: wrap;">
                            <p>{{ @$auction->prop_condition }}</p>
                        </div>
                        <hr>
                        <h4>Description of the ideal agent for the property:</h4>
                        <div class="row" style="flex-wrap: wrap;">
                            <p>{{ @$auction->description_ideal_agent }}</p>
                        </div> --}}
                ...
                @if ($auth_id)
                    @if (in_array(auth()->user()->user_type, ['agent']))
                        <button class="btn w-100" data-bs-toggle="modal" data-bs-target="#exampleModal"
                            ...
                            <span
                                class="badge bg-light float-end text-dark">{{@$auction->min_price_in=="$"?"$":""}}{{ number_format(@$auction->min_price, 0, '.', '') }}{{@$auction->min_price_in=="%"?"%":""}}</span>
                            @if (@$auction->sold)
                                    ...
                                    <div class="accordion" type="button" data-bs-toggle="collapse"
                                        ...
                                        <div class="d-flex small accordion mr-0 text-center">
                                            ...
                                            <div class="col-4 text-right">
                                                {{$bid->price_in=="$"?"$":""}}{{ number_format($bid->price, 0, '.', '') }}{{$bid->price_in=="%"?"%":""}} </div>
                                            <div class="col-2">
                                                Terms↓
                                            </div>
                                        </div>
                                        ...
                                        <div class="accordion-body">
                                            <div id="bidding_history_data">
                                                <div>
                                                    ...
                                                    @if (@$auction->user_id == $auth_id)
                                                        @if (!@$auction->is_sold)
                                                            <form action="{{ route('agent.acceptASBid') }}"
                                                                method="post">
                                                                @csrf
    ...
    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form action="{{ route('agent.saveASBid') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="auction_id" value="{{ @$auction->id }}">
                    <div class="modal-body">
                        <div class="d-flex justify-content-between mb-2">
                            <div style="font-size:18px; font-weight:bold;">
                                {{@$auction->min_price_in=="$"?"$":""}}{{ number_format(@$auction->min_price, 0, '.', '') }}{{@$auction->min_price_in=="%"?"%":""}}</div>
                            <div style="color: rgba(0,0,0,0.5);">Minimum Price</div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                    ...
                                    <div class="col-md-6 mb-2">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-text p-0">
                                                <select name="price_in" class="form-select" style="background-color: #e9ecef; border:0;">
                                                    <option value="$">$</option>
                                                    <option value="%">%</option>
                                                </select>
                                            </div>
