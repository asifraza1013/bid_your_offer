    ...
    <div class="card">
      <div class="row">
        <div class="col-12 p-4">
          <form class="p-4 pt-0 mainform" action="{{ route('buyer.add-counter-terms') }}" method="POST"
            ...
            <div class="container">
                ...
                <span class="incomeFields">
                  ...
                  <div class="form-group OtherCommissionIncome d-none">
                    ...
                    <input type="text" name="OtherCommission" class="form-control has-icon col-3"
                      data-icon="fa-solid fa-qrcode" data-msg-required="" required>
                  </div>
              ...
              <div class="wizard-step" data-step="3">
                @php
                  $commission = [['icon' => 'fa-regular fa-circle-check', 'name' => 'Yes'], ['icon' => 'fa-regular fa-circle-xmark', 'name' => 'No'], ['icon' => 'fa-regular fa-circle-check', 'name' => 'Optional']];
                ...
                <div class="form-group">
                  ...
                  <select class="grid-picker" name="compensation" id="property_type" required>
                    ...
                    @foreach ($commission as $item)
                      <option value="{{ $item['name'] }}" class="card flex-column" style="width:calc(33.3% - 10px);"
              ...
              <div class="wizard-step" data-step="4">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group serviceOther d-none">
                    ...
                    <input type="text" class="form-control has-icon" name="serviceOther" data-icon="fa-solid fa-qrcode"
                      required />
                  </div>
                </div>
              </div>
              <div class="wizard-step" data-step="5">
                <div class="form-group">
                  ...
                  <textarea name="additionalDetails" class="form-control" rows="5">{{ old('additionalDetails') }}</textarea>
                </div>
              </div>
