      ...
      <div class="col-sm-12 col-md-8 col-lg-8 leftCol">
        ...
        <div class="card description">
          <div class="card-body">
            ...
            @if (@$auction->get->leaseRoom != '' && @$auction->get->leaseRoom != 'null')
              <div class="col-md-12 col-12 fw-bold"><i class="fa-regular fa-check-square"></i> Leasing Space
                :<span
                  class="removeBold"> {{ @$auction->get->leaseRoom }}</span>
                <br>
                @if (@$auction->get->leaseRoom == 'Single Room')
                  <span class="removeBold">
                    <ul class="leasing">
                      <div>
                        <li style="font-size:16px;"><span class="fw-bold">What is the size of the room the landlord
                            intends to lease?</span></li>
                        {{ @$auction->get->sizeOfRoom }}
                      </div>
                      <div>
                        <li style="font-size:16px;"><span class="fw-bold">Is there a private bathroom, or is it
                            shared?</span></li>
                        {{ @$auction->get->privateBathroom }}
                      </div>
                      <div>
                        <li style="font-size:16px;"><span class="fw-bold">How much storage space is available?</span></li>
                        {{ @$auction->get->storageSpace }}
                      </div>
                      <div>
                        <li style="font-size:16px;"><span class="fw-bold">Can tenants use common areas like the kitchen,
                            living room, or
                            backyard?</span></li>
                        {{ @$auction->get->commonAreas }}
                      </div>
                      <div>
                        <li style="font-size:16px;"><span class="fw-bold">How is cleaning and maintenance of common areas
                            managed?</span></li>
                        {{ @$auction->get->areasManaged }}
                      </div>
                      <div>
                        <li style="font-size:16px;"><span class="fw-bold">Are tenants allowed to have guests, and if so,
                            are there any
                            restrictions?</span></li>
                        {{ @$auction->get->tenantsGuests }}
                      </div>
                      <div>
                        <li style="font-size:16px;"><span class="fw-bold">How are maintenance issues handled?</span></li>
                        {{ @$auction->get->maintenanceIssues }}
                      </div>
                      <div>
                        <li style="font-size:16px;"><span class="fw-bold">How are the utilities split?</span></li>
          ...
          @if (@$auction->get->net_leasable_square_footage != '' && @$auction->get->net_leasable_square_footage != 'null')
            <div class="col-md-12 col-12 fw-bold"><i class="fa-regular fa-check-square"></i> Net Leaseable Sqft:
                <span class="removeBold">
            ...
            @if (@$auction->get->heated_sqft != '' && @$auction->get->heated_sqft != 'null')
              <div class="col-md-12 col-12 fw-bold"><i class="fa-regular fa-check-square"></i> Sqft Heated Source:
                <span class="removeBold">
            ...
            @if (@$auction->get->petOptions != '' && @$auction->get->petOptions != 'null' && @$auction->get->petOptions == 'Yes')
              <div class="col-md-12 col-12 fw-bold"><i class="fa-regular fa-check-square"></i> How many pets does the
                buyer have?
                <span class="removeBold">
            ...
            @endif
            @if (@$auction->get->petOptions != '' && @$auction->get->petOptions != 'null' && @$auction->get->petOptions == 'Yes')
              <div class="col-md-12 col-12 fw-bold"><i class="fa-regular fa-check-square"></i> What type of pet(s) does
                the buyer have?
                <span class="removeBold">
            ...
            @endif
            @if (@$auction->get->petOptions != '' && @$auction->get->petOptions != 'null' && @$auction->get->petOptions == 'Yes')
              <div class="col-md-12 col-12 fw-bold"><i class="fa-regular fa-check-square"></i> What is the weight of
                the pet(s)?
                <span class="removeBold">
            ...
            @if (@$auction->get->total_acreage != '' && @$auction->get->total_acreage != 'null')
              <div class="col-md-12 col-12 fw-bold"><i class="fa-regular fa-check-square"></i> Appliances Included:
            ...
            @if (@$auction->get->parkingOptions != '' && @$auction->get->parkingOptions != 'null')
              <div class="col-md-12 col-12 fw-bold"><i class="fa-regular fa-check-square"></i> Garage/Parking Features:
            ...
            @endif
            @if (@$auction->get->total_acreage != '' && @$auction->get->total_acreage != 'null')
              <div class="col-md-12 col-12 fw-bold"><i class="fa-regular fa-check-square"></i> Utilities Included:
            ...
            @endif
            <div class="col-md-12 col-12 fw-bold"><i class="fa-regular fa-check-square"></i> Amenities and Property
              Features:
            ...
            <div class="card-body">
              ...
              @if (@$auction->get->expectation != '' && @$auction->get->expectation != 'null')
                <div class="row" style="flex-wrap: wrap;">
                  <div class="col-12 fw-bold"> <i class="fa-regular fa-check-square"></i> Desired Rental Amount:
              ...
              @if (@$auction->get->occupant_type != '' && @$auction->get->occupant_type != 'null')
                <div class="row" style="flex-wrap: wrap;">
                  <div class="col-12 fw-bold"> <i class="fa-regular fa-check-square"></i> Occupancy Status:<span
                      class="removeBold">({{ @$auction->get->occupant_type }})</span><br>

                    @if ($auction->get->occupant_type == 'Occupied')
                      <span class="removeBold">Occupied Until {{ @$auction->get->occupied_until }}</span>
                    @endif
                  </div>
                </div>
              @endif
              @if (@$auction->get->lease_period != '' && @$auction->get->lease_period != 'null')
                <div class="row" style="flex-wrap: wrap;">
                  <div class="col-12 fw-bold"> <i class="fa-regular fa-check-square"></i> Desired Lease
                    Length:<span class="removeBold">{{ $auction->get->lease_period == 'Other' ? '(Other)' : '' }}

                      @if (@$auction->get->lease_period != 'Other')
                        <span class="removeBold">{{ @$auction->get->lease_period }}</span>
                      @else
                        <br>
                        <ul class="leasing">
                          <li style="font-size:16px;">
                            <span class="fw-bold">What amenities or features does the property
                              offer?</span>
                            <span class="removeBold"> {{ $auction->get->custom_lease_period }}</span>
                          </li>
                        </ul>
                      @endif
                  </div>
              ...
              @if (@$auction->get->listing_term != '' && @$auction->get->listing_term != 'null')
                <div class="row" style="flex-wrap: wrap;">
                  <div class="col-12 fw-bold"> <i class="fa-regular fa-check-square"></i> Offered Timeframe for the
                    Landlord
                    Agency
                    Agreement:<span
                      class="removeBold">{{ $auction->get->listing_term == 'Other' ? '(Other)' : '' }}</span>

                    @if (@$auction->get->listing_term != 'Other')
                      <span class="removeBold">{{ @$auction->get->listing_term }}</span>
                    @else
                      <br>
                      <ul class="leasing">
                        <li style="font-size:16px;">
                          <span class="fw-bold">What is the timeframe offered to the agent in the Landlord Agency
                            Agreement?</span>
              ...
              @if (@$auction->get->offered_commission != '' && @$auction->get->offered_commission != 'null')
                <div class="row" style="flex-wrap: wrap;">
                  <div class="col-12 fw-bold"> <i class="fa-regular fa-check-square"></i> Listing Agent Commission Offered:<span class="removeBold">{{ $auction->get->offered_commission == 'Other' ? '(Other)' : '' }}</span>
                    ...
                    @else
                      ...
                      <ul class="leasing">
                        <li style="font-size:16px;">
                          <span class="fw-bold">What is the total commission being offered to the listing agent? </span>
              ...
              @if (@$auction->get->tenantCommission != '' && @$auction->get->tenantCommission != 'null')
                <div class="row" style="flex-wrap: wrap;">
                  <div class="col-12 fw-bold"> <i class="fa-regular fa-check-square"></i> Tenant Agent Commission
                    Split:<span class="removeBold">{{ $auction->get->tenantCommission == 'Other' ? '(Other)' : '' }}</span>
                    ...
                    @else
                      ...
                      <ul class="leasing">
                        <li style="font-size:16px;">
                          <span class="fw-bold">If a tenant is represented by an agent, what portion of the commission
                            should be
                            shared with the tenant’s agent? </span>
                          <span class="removeBold"> {{ $auction->get->offeredCommissionOther }}</span>
                        </li>
                      </ul>
                    @endif
            ...
            <hr>
            <div class="card-body">
              <h4>Services the Landlord Requests from Their Agent:</h4>
                    ...
                    <div class="accordion-body">
                      <div id="bidding_history_data">
                        <div>
                          ...
                          <p class="d-flex justify-content-between small">Landlord Agency Agreement Timeframe:
