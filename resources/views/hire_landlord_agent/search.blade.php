              ...
              <div class="card-footer bg-light">
                <div class="row">
                  ...
                  <div class="col-6 right text-end">
                    <b>{{ @$auction->get->custom_expectation == '' ? @$auction->get->expectation : @$auction->get->custom_expectation }}</b>
                  </div>
                </div>
              </div>
