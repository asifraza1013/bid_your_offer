    ...
    <div class="card">
      <div class="row">
        <div class="col-12 p-4">
          <form class="p-4 pt-0 validate mainform" action="{{ route('landlord.hire.agent.auction') }}" method="POST"
            ...
            <div class="container">
              ...
              <div class="wizard-step" data-step="2">
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="address" class="form-control search_places has-icon" data-type="address"
                    required value="{{ old('address') }}" data-icon="fa-solid fa-location-dot" placeholder="" />
                ...
                <small class="mt-1 fs-5">Note: The listing's address remains confidential until a seller employs an agent.
                </small>
              </div>
              {{-- Slide 2 --}}
              {{-- Slide 3 --}}
              ...
              <div class="wizard-step" data-step="5">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control has-icon" name="titleListing" id="" required
              ...
              <div class="wizard-step" data-step="7">
                <span class="resFields">
                  ...
                  @endphp
                  <div class="form-group">
                    <label class="fw-bold">Leasing Space:
                    </label>
                    <select class="grid-picker" name="leaseRoom" id="prop_condition"
                      ...
                      @foreach ($lease_prop_res as $item)
                        <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}" class="card flex-row"
                          data-icon='<i class="fa-regular fa-circle-check"></i>' style="width:calc(50% - 10px);">
                          {{ $item['name'] }}
                        </option>
                      @endforeach
                    </select>
                      ...
                      <div class="form-group input-cover">
                        <span class="commercialFields">
                          ...
                          <input type="text" class="form-control has-icon" data-icon="fa-solid fa-ruler-combined"
                            name="sizeOfRoom" id="roomSize" required />
                          <label class="fw-bold">Is there a designated reception area?</label>
                          <input type="text" class="form-control has-icon" data-icon="fa-solid fa-ruler-combined"
                            name="designatedReceptionArea" id="designatedReceptionArea" required />
                          <label class="fw-bold">How is the layout of the commercial space configured?</label>
                          <input type="text" class="form-control has-icon" data-icon="fa-solid fa-ruler-combined"
                            name="layoutConfiguration" id="layoutConfiguration" required />
                          <label class="fw-bold">Are there specific zoning restrictions or permitted uses for the
                            space?</label>
                          <input type="text" class="form-control has-icon" data-icon="fa-solid fa-ruler-combined"
                            name="zoningRestrictions" id="zoningRestrictions" required />
                          <label class="fw-bold">How much storage space is available?</label>
                          <input type="text" class="form-control has-icon" data-icon="fa-solid fa-ruler-combined"
                            name="storageSpace" id="storageSpaceAvailable" required />
                          <label class="fw-bold">Are there any shared amenities, such as conference rooms or parking
                            facilities?</label>
                          <input type="text" class="form-control has-icon" data-icon="fa-solid fa-ruler-combined"
                            name="sharedAmenities" id="sharedAmenities" required />
                          <label class="fw-bold">How is cleaning and maintenance of common areas managed?</label>
                          <input type="text" class="form-control has-icon" data-icon="fa-solid fa-ruler-combined"
                            name="areasManaged" required />
                          <label class="fw-bold">Are there specific hours of operation for the building, and is 24/7
                            access available?</label>
                          <input type="text" class="form-control has-icon" data-icon="fa-solid fa-ruler-combined"
                            name="hoursOfOperation" id="hoursOfOperation" required />
                          <label class="fw-bold">How are maintenance issues and repairs handled for the commercial
                            space?</label>
                          <input type="text" class="form-control has-icon" data-icon="fa-solid fa-ruler-combined"
                            name="maintenanceHandling" id="maintenanceHandling" required />
                          <label class="fw-bold">How are the utilities split?</label>
                          <input type="text" class="form-control has-icon" data-icon="fa-solid fa-ruler-combined"
                            name="utilitiesSplit" id="utilitiesSplit" required />
                          <label class="fw-bold">What types of businesses are neighboring tenants in the building or
                        ...
                        <span class="resFields">
                          <label class="fw-bold"> What is the size of the room the landlord intends to lease?</label>
                          <input type="text" class="form-control has-icon" data-icon="fa-solid fa-ruler-combined"
                            name="sizeOfRoom" id="custom_property_condition" required />
                          <label class="fw-bold"> Is there a private bathroom, or is it shared?</label>
                          <input type="text" class="form-control has-icon" data-icon="fa-solid fa-ruler-combined"
                            name="privateBathroom" id="custom_property_condition" required />
                          <label class="fw-bold"> How much storage space is available?</label>
                          <input type="text" class="form-control has-icon" data-icon="fa-solid fa-ruler-combined"
                            name="storageSpace" id="custom_property_condition" required />
                          <label class="fw-bold">Can tenants use common areas like the kitchen, living room, or
                            backyard?</label>
                          <input type="text" class="form-control has-icon" data-icon="fa-solid fa-ruler-combined"
                            name="commonAreas" id="custom_property_condition" required />
                          <label class="fw-bold">How is cleaning and maintenance of common areas managed?</label>
                          <input type="text" class="form-control has-icon" data-icon="fa-solid fa-ruler-combined"
                            name="areasManaged" id="custom_property_condition" required />
                          <label class="fw-bold">Are tenants allowed to have guests, and if so, are there any
                            restrictions?</label>
                          <input type="text" class="form-control has-icon" data-icon="fa-solid fa-ruler-combined"
                            name="tenantsGuests" id="custom_property_condition" required />
                          <label class="fw-bold">How are maintenance issues handled?</label>
                          <input type="text" class="form-control has-icon" data-icon="fa-solid fa-ruler-combined"
                            name="maintenanceIssues" id="custom_property_condition" required />
                          <label class="fw-bold">How are the utilities split?</label>
                          <input type="text" class="form-control has-icon" data-icon="fa-solid fa-ruler-combined"
                            name="utilitiesSplit" id="custom_property_condition" required />
                        </span>
                      </div>
                    </div>
                  </div>
                ...
                <span class="commercialFields">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group singleRoomCommercial d-none">
                      <div class="form-group">
                        <label class="fw-bold" for="roomSize">What is the size of the room the landlord intends to
                          lease?</label>
                      ...
                      <div class="form-group">
                        <label class="fw-bold" for="accessHours">What are the access hours to the commercial
                          space?</label>
                        <input type="text" name="leaseSingleRoom[]" id="accessHours"
                          data-icon ="fa-solid fa-ruler-combined" class="form-control has-icon" required>
                      </div>
                      <div class="form-group">
                        <label class="fw-bold" for="roomDescription">Can you provide a detailed description of the room
                          and its
                          dimensions?</label>
                      ...
                      <div class="form-group">
                        <label class="fw-bold" for="bathroomType">Is there a private bathroom, or is it shared?</label>
                        <input type="text" name="leaseSingleRoom[]" id="bathroomType"
                          data-icon ="fa-solid fa-ruler-combined" class="form-control has-icon" required>
                      </div>
                      <div class="form-group">
                        <label class="fw-bold" for="spaceRestrictions">Are there any restrictions on how the space can
                          be used or
                          modified?</label>
                      ...
                      <div class="form-group">
                        <label class="fw-bold" for="cleaningMaintenance">How is cleaning and maintenance of common areas
                          managed?</label>
                      ...
                      <div class="form-group">
                        <label class="fw-bold" for="sharedAmenities">Are there shared amenities, and how are they
                          maintained?</label>
                        <input type="text" name="leaseSingleRoom[]" id="sharedAmenities"
                          class="form-control has-icon" data-icon ="fa-solid fa-ruler-combined" required>
                      </div>
                      <div class="form-group">
                        <label class="fw-bold" for="maintenanceResponsibility">Who is responsible for maintenance and
                          repairs within the
                          rented space?</label>
                        <input type="text" name="leaseSingleRoom[]" id="maintenanceResponsibility"
                          class="form-control has-icon" data-icon ="fa-solid fa-ruler-combined" required>
                      </div>
                      <div class="form-group">
                        <label class="fw-bold" for="utilitiesSplit">How are the utilities split?</label>
                        <input type="text" name="leaseSingleRoom[]" id="utilitiesSplit"
                          class="form-control has-icon" data-icon ="fa-solid fa-ruler-combined" required>
                      </div>
                      <div class="form-group">
                        <label class="fw-bold" for="storageSpace">How much storage space is available?</label>
                        <input type="text" name="leaseSingleRoom[]" id="storageSpace" class="form-control has-icon"
              ...
              <div class="wizard-step bedroom" data-step="9">
                <span class="resFields">
                  ...
                  <div class="form-group">
                    ...
                    <select class="grid-picker" name="bedrooms" id="bedrooms" style="justify-content: flex-start;"
                      required>
                      <option value="">Select</option>
              ...
              <div class="wizard-step bedroom" data-step="10">
                <div class="form-group">
                  ...
                  <select class="grid-picker" name="bathrooms" id="bathrooms" style="justify-content: flex-start;"
                    required>
                    <option value="">Select</option>
              ...
              <div class="wizard-step" data-step="11">
                <div class="form-group residential_hide">
                  ...
                  <input type="text" name="heated_square_footage" data-type="heated_square_footage"
                    id="heated_square_footage" class="form-control has-icon" data-icon="fa-solid fa-ruler-combined"
                ...
                <div class="form-group commercial_hide">
                  <div class="form-group">
                    ...
                    <input type="text" name="net_leasable_square_footage"id="net_square_footage"
                      class="form-control has-icon" data-icon="fa-solid fa-ruler-combined" data-msg-required=""
                      required />
                  </div>
                  <div class="form-group">
                    <label class="fw-bold">Total Sqft: </label>
                    <input type="text" name="totalSqft" id="net_square_footage" class="form-control has-icon"
              ...
              <div class="wizard-step" data-step="14">
                <span class="resFields">
                  @php
                    $garageOptions = [
                        ['target' => '.garageYes', 'name' => 'Yes', 'icon' => 'fa-regular fa-check-circle'],
                        ['target' => '.garageNo', 'name' => 'No', 'icon' => 'fa-regular fa-circle-xmark'],
                        ['target' => '.garageOptional', 'name' => 'Optional', 'icon' => 'fa-regular fa-check-circle'],
                    ];
                  @endphp
                  ...
                  @php
                    $carportOptions = [
                        ['target' => '.carportOptionsYes', 'name' => 'Yes', 'icon' => 'fa-regular fa-check-circle'],
                        ['target' => '.carportOptionsNo', 'name' => 'No', 'icon' => 'fa-regular fa-circle-xmark'],
                        [
              ...
              <div class="wizard-step" data-step="15">
                <div class="form-group">
                  ...
                  <div class="form-group d-none ">
                    ...
                    <input type="number" name="customPool" data-type="pool" placeholder="Enter Heated Square Footage"
                      id="pool" class="form-control has-icon"
                ...
                <div class="row align-items-end mt-4">
                  @php
                    $views = [
                        ...
                        ['target' => '.viewOther', 'name' => ' Other', 'icon' => 'fa-regular fa-check-circle'],
                    ];
                  @endphp
                  <div class="select2-parent">
                ...
                <span class="commercialFields">
                  <div class="form-group">
                    ...
                    <div class="form-group d-none garageOptionYes">
                      <select class="grid-picker" name="parking" style="justify-content: flex-start;" required>
                        <option value="">Select</option>
                      ...
                      <div class="form-group other_garage d-none">
                        ...
                        <input type="text" name="parkingOther" class="form-control has-icon hide_arrow"
                          data-icon="fa-solid fa-ruler-combined" required>
                      </div>
                    </div>
                  </div>
              ...
              <div class="wizard-step" data-step="19">
                ...
                <div class="form-group">
                  ...
                  <select class="grid-picker" name="Furnishings" id="appliances" style="justify-content: flex-start;"
                    multiple required>
                    <option value="">Select</option>
              ...
              <div class="wizard-step" data-step="20">
                <span class="commercialFields">
                  ...
                  <div class="form-group otherAmenitiesFeatureCommercial d-none">
                    <label class="fw-bold" for="custom_non_negotiable_terms"> What amenities or features does the
                      property offer?
                    </label>
                    <input type="text" name="otherAmenities" id="custom_non_negotiable_terms" placeholder=""
                      class="form-control" data-icon="fa-solid fa-ruler-combined" required>
                  </div>
                </span>
                <span class="resFields">
                  <div class="form-group">
                  ...
                  <div class="form-group otherAmenitiesFeatureRes d-none">
                    <label class="fw-bold" for="custom_negotiable_terms"> What amenities or features does the property
                      offer?
                    </label>
              ...
              <div class="wizard-step" data-step="22">
                ...
                <div class="form-group otherTenantPays d-none">
                  <label class="fw-bold">Tenant Pays: </label>
                  <input type="text" class="form-control has-icon" placeholder="" name="otherTenantPays"
                    data-icon="fa-solid fa-ruler-combined" id="rent_include" required />
                </div>
                @php
                  $ownerPays = [
                ...
                <div class="form-group">
                  ...
                  <select class="grid-picker" name="ownerPays[]" id="" style="justify-content: flex-start;"
                    multiple required>
                    <option value="">Select</option>
                ...
                <div class="form-group otherOwnerPays d-none">
                  <label class="fw-bold">Landlord Pays:</label>
                  <input type="text" class="form-control has-icon" placeholder="" name="otherOwnerPays"
                    data-icon="fa-solid fa-ruler-combined" id="rent_include" required />
                </div>
                ...
                <div class="row align-items-end mt-4">
                  <div class="col-md-12">
                    ...
                    <div class="form-group petYes d-none">
                      ...
                      <div class="form-group">
                        <label class="fw-bold" for="heated_sqft">One-Time Pet Deposit or Monthly Pet Fee:</label>
                      ...
                      <div class="form-group">
                        <label class="fw-bold" for="heated_sqft">Is the Pet Fee Refundable or Non-Refundable?</label>
              ...
              <div class="wizard-step" data-step="24">
                <div class="form-group">
                  ...
                  @endphp
                  <select name="propertyLoc" id="propertyLoc" class="grid-picker" style="justify-content: flex-start;"
                    required>
                    <option value=""></option>
              ...
              <div class="wizard-step" data-step="25">
                ...
                <span class="commercialFields">
                  @php
                    $leaseAmount = [['name' => 'Annually', 'target' => ''], ['name' => 'Monthly', 'target' => '']];
                  @endphp
                </span>
                <div class="form-group">
                  <label class="fw-bold">Select the frequency in which the Lease Amount is paid: </label>

                  <select class="grid-picker" name="leaseAmount" id="appliances" style="justify-content: flex-start;"
                    multiple required>
                    <option value="">Select</option>
              ...
              <div class="wizard-step" data-step="26">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group otherLeaseDuration d-none">
                    <label class="fw-bold">Acceptable Lease Duration: <span class="text-danger"></span></label>
              ...
              <div class="wizard-step" data-step="27">
                ...
                <div class="form-group">
                  ...
                  <select class="grid-picker" name="termLease" id="appliances" style="justify-content: flex-start;"
                    multiple required>
                    <option value="">Select</option>
              ...
              <div class="wizard-step" data-step="28">
                ...
                <div class="form-group custom_occupant_type d-none">
                  ...
                  <input type="date" class="form-control has-icon" placeholder=" " name="occupied_until"
                    data-icon="fa-solid fa-calendar-days" id="occupant_type_input" required />
                </div>
              </div>
              ...
              <div class="wizard-step" data-step="32">
                ...
                <div class="form-group custom_listing_terms_residential d-none ">
                  <label class="fw-bold">What is the timeframe offered to the agent in the Landlord Agency
                    Agreement?</label>
              ...
              <div class="wizard-step" data-step="33">
                <div class="form-group ">
                  ...
                  <div class="form-group commissionOther d-none ">
                    ...
                    <input type="text" class="form-control has-icon" name="offeredCommissionOther"
                      data-icon="fa-solid fa-dollar-sign" id="custom_offered_commission" required />
                  </div>
                </div>
              </div>
              ...
              <div class="wizard-step" data-step="34">
                <div class="row">
                  <div class="form-group mt-4 col-md-12">
                    <label class='fw-bold'>
                      What are the most important aspects the landlord will consider when hiring a real estate agent?
                    </label>
              ...
              <div class="wizard-step residential_remove" data-step="35">
                <span class="resFields">
                  <div class="form-group">
                    ...
                    @php
                      $serviceRes = [
                          ...
                          ['name' => 'Conduct property showings and viewings for interested tenants.', 'target' => ''],
                          [
                              'name' =>
                          ...
                          ['name' => 'Other - Add additional services as needed.', 'target' => '.otherRes'],
                      ];

                    @endphp
                    <select name="services[]" multiple class="grid-picker" style="justify-content: flex-start;"
                      required>
                      <option value=""></option>
                  ...
                  <div class="form-group otherRes d-none">
                    <label class="fw-bold">What services would the landlord like to request from an agent?
                    </label>
                ...
                <span class="commercialFields">
                  <div class="form-group">
                    ...
                    @php
                      $serviceCommercial = [
                          ...
                          ['name' => 'Other - Add additional services as needed.', 'target' => '.otherCommercial'],
                      ];
                    @endphp
                    <select name="services[]" multiple class="grid-picker" style="justify-content: flex-start;"
                      required>
                  ...
                  <div class="form-group otherCommercial d-none">
                    <label class="fw-bold">What additional services would the landlord like to request from an agent?
                    </label>
                    <input type="text" class="form-control has-icon" name="servicesOther"
                      data-icon="fa-solid fa-ruler-combined" id="custom_services_data" required />
                  </div>
