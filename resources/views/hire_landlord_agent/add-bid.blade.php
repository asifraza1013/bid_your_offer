                ...
                <form class="p-4 pt-0 mainform" action="{{ route('landlord.agent.auction.bid.save') }}" method="POST"
                    ...
                    <div class="wizard-step">
                        ...
                        <div class="form-group">
                            <label class="fw-bold">What is the timeframe offered by the agent for the landlord agency agreement?
                            </label>
                    ...
                    <div class="wizard-step">
                        ...
                        <div class="form-group">
                            ...
                            @endphp
                            <label class="fw-bold">What compensation will the listing broker accept from the owner for their services?
                            </label>
