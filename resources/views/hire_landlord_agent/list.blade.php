                        ...
                        <td class="text-center">
                          <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                              ...
                              <li>
                                @php
                                  $counter = App\Models\LandlordCounterTerm::where('landlord_auction_id', @$auction->id)->first();
                                @endphp
                                @if (isset($counter))
                                  <a class="dropdown-item"
                                    href="{{ route('landlord.edit-counter-terms', $auction->id) }}">
                                    <i class="fa-solid fa-edit" style="font-size:14px;"></i>
                                    <span style="font-size:14px;">Countered Terms <span class="badge p-2"
                                ...
                                @else
                                  <a class="dropdown-item" href="{{ route('landlord.counter-terms', $auction->id) }}">
