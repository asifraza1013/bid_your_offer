                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <ul class="dropdown-menu">
                                                            ...
                                                            @if (!@$auction->is_approved)
                                                                <li>
                                                                    <a class="dropdown-item"
                                                                        href="{{ route('landlord.hire.agent.auction.edit', @$auction->id) }}">
                                                                ...
                                                                @if (isset($counter))
                                                                    ...
                                                                    <a data-toggle="modal"
                                                                        ...
                                                                        <i class="fa-solid fa-eye"
                                                                            style="font-size:14px;"></i>
                                                                        <span style="font-size:14px;">Countered Terms
                                                                        </span>
                                                                    </a>
                                                                @else
                                                                    <a class="dropdown-item"
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">Sellers's
                                                                Countered Terms</h5>
                                                            <button type="button"
                                                            ...
                                                            <div class="row" style="flex-wrap: wrap;">
                                                                @if (isset($counter->timeframe))
                                                                    <div class="col-md-12 col-12 pt-2 removeBold"><i
                                                                        ...
                                                                        <span class="fw-bold">Offered Timeframe for the
                                                                            Seller Agency Agreement:</span>
                                                                        {{ $counter->timeframe }}
                                                                    </div>
                                                                @endif
                                                                @if (isset($counter->commission))
                                                                    <div class="col-md-12 col-12 pt-2 removeBold"><i
                                                                            class="fa-regular fa-check-square"></i>
                                                                        <span class="fw-bold">Total Commission being offered
                                                                            to the agent:</span>
                                                                        {{ $counter->commission }}
                                                                    </div>
                                                                @endif
                                                                @if (isset($counter->services))
                                                                    <div class="col-md-12 col-12 pt-2 removeBold services">
                                                                        <i class="fa-regular fa-check-square"></i><span
                                                                            class="fw-bold"> Select the services
                                                                            the seller wants the hired agent to provide:
                                                                        </span>
                                                                        @php
