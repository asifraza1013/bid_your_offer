...
<div id="frame">
    ...
    <div class="chat-input row">
        <div class="col-10">
            <input type="input-text" class="message-input" name="question" placeholder="Type your message" style="    width: 100%;
            height: 50px;
            border-radius: 4px;">
            <input type="hidden"  data-id="{{ $id }}">
        </div>
        <div class="col-2">
            <button id="submit12" style="width: auto;" class="submit12" class="send-message-btn">Send</button>
        </div>
