...
<![endif]-->
    ...
    <style type="text/css" class="export-delete">
        ...
        .composer--mobile .left-float {
            float: left !important;
        }

        .composer--mobile .right-float {
            float: right !important;
        }

        .composer--mobile .right-text {
            text-align: right !important;
        }
        ...
        .composer--mobile .preheader-container {
            text-align: center !important;
        }
        ...
        .composer--mobile .rwd-on-mobile-np {
            display: inline-block !important;
        }
...
<body data-bgcolor="Body"
    ...
    <div data-primary-font="Poppins" data-secondary-font="Archivo"
    ...
    <table border="0" align="center" cellpadding="0" cellspacing="0" width="100%"
        ...
        <tr>
            <!-- Outer Table -->
            <td align="center" data-bgcolor="Body" bgcolor="#E5E5E5" data-composer>
                                ...
                                <tr>
                                    <td align="center">
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" align="center"
                                            ...
                                            <tr>
                                                <td class="rwd-col" align="center" width="48.28%"
                                                    style="width:48.28%;max-width:48.28%;">
                                                    ...
                                                    <table border="0" align="center" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td align="center">
                                                                <img style="width:171px;border:0px;display: inline!important;"
                                                                    src="http://bidyouroffer.com/assets/pictures/logo.png" width="171" border="0"
                                                                    editable="true" data-icon data-image-edit data-url
                                                                    data-label="Logo" data-image-width alt="logo">
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <!-- column -->
                ...
                <table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0"
                    class="outer-table row" role="presentation" width="640" style="width:640px;max-width:640px;"
                    data-module="evepra-dotted-divider">
                    <!-- evepra-dotted-divider -->
                    <tr>
                        <td align="center" bgcolor="#FFFFFF" data-bgcolor="BgColor" height="30"
                            style="font-size:30px;line-height:30px;" data-height="dotted-divider Height">
                            <table data-inner-table data-element="evepra-dotted-dividers" data-label="dotted-divider"
                                border="0" align="center" cellpadding="0" cellspacing="0"
                                class="inner-table container-padding" role="presentation" width="100%"
                                style="width:100%;max-width:100%;">
                                <tr>
                                    <td align="center" height="5" style="font-size:5px;line-height:5px;">&nbsp;
                                    </td>
                                </tr>
                                <tr>
                                    <td align="center" height="5" data-bgcolor="dotted-dividers"
                                        style="font-size:5px;line-height:5px;border-top: 5px dotted #DDDDDD;">&nbsp;
                                    </td>
                                </tr>
                            </table>
                        </td>
                            ...
                            <table data-inner-table border="0" align="center" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td align="center">
                                        ...
                                        <table border="0" align="center" cellpadding="0" cellspacing="0"
                                            role="presentation" width="100%" style="width:100%;max-width:100%;">
                                            <tr data-element="evepra-schedule-2-title" data-label="Titles">
                                                <td data-text-style="Titles" align="left"
                                                    style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:32px;line-height:40px;font-weight:700;font-style:normal;color:#041A57;text-decoration:none;letter-spacing:0px;">
                                                    <singleline>
                                            ...
                                            <tr data-element="evepra-schedule-2-paragraph" data-label="Paragraphs">
                                                <td data-text-style="Paragraphs" align="left"
                                                    style="font-family:'Archivo',Arial,Helvetica,sans-serif;font-size:18px;line-height:32px;font-weight:400;font-style:normal;color:#000000;text-decoration:none;letter-spacing:0px;">
                                                    <singleline>
                                                        <div mc:edit data-text-edit>
                                                            {{$msg}}
                                                        </div>
                ...
                <table data-outer-table border="0" align="center" cellpadding="0" cellspacing="0"
                    class="outer-table row" role="presentation" width="640" style="width:640px;max-width:640px;"
                    data-module="evepra-location">
                    <!-- evepra-location -->
                    <tr>
                        <td align="center" bgcolor="#ECF1F9" data-bgcolor="BgColor">
                    ...
                    <tr>
                        <td align="center" bgcolor="#FFFFFF" data-bgcolor="BgColor">
                            ...
                            <table data-inner-table border="0" align="center" cellpadding="0" cellspacing="0"
                                role="presentation" class="inner-table row container-padding" width="580"
                                style="width:580px;max-width:580px;">
                                <tr data-element="evepra-footer-social-icons" data-label="Social Icons">
                                    <td height="30" style="font-size:30px;line-height:30px;"
                                        data-height="Spacing under social icons">&nbsp;</td>
                                </tr>

                                <tr data-element="evepra-footer-paragraphs" data-label="Paragraphs">
                                    <td align="center">
                                        <table border="0" align="center" cellpadding="0" cellspacing="0"
                                            role="presentation" class="row" width="480"
                                            style="width:480px;max-width:480px;">
                                            <tr>
                                                <td data-text-style="Paragraphs" align="center"
                                                    style="font-family:'Roboto',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#999999;text-decoration:none;letter-spacing:0px;">
                                                    <multiline>
                                                        <div mc:edit data-text-edit>
                                                            2022 Εvepra Inc. All Rights Reserved.<br>
                                                            Address name St. 254, City Name, State, Country Name
                                                        </div>
                                                    </multiline>
                                                </td>
                                            </tr>
