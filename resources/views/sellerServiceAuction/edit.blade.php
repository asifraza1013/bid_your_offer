        ...
        <div class="card">
            <div class="row">
                <div class="col-12 p-4">
                    <form class="p-4 pt-0" action="{{ route('seller.service.auction.update') }}" method="POST"
                                ...
                                <div class="form-group col-md-4 mt-4">
                                    ...
                                    <select name="services[]" class="form-select multiple" multiple>
                                        @foreach ($services as $service)
                                            <option value="{{$service->id}}" @if($auction->services) {{ in_array($service->id, json_decode($auction->services))?"selected":"" }} @endif >{{$service->name}}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row align-items-end">
                                ...
                                <div class="form-group col-md-3 mt-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control border-start-0 mb-0" name="price"
                                            min="0" required placeholder="0.00" value="{{ $auction->price }}">
                                    </div>
                                    @if ($errors->has('price'))
                                ...
                                <div class="card-body p-2">
                                    <div class="row">
                                        <div class="form-group mt-0 col-md-4">
                                            <label>Name:</label>
                                            <input type="text" name="seller_name" class="form-control" value="{{$auction->seller_name}}">
                                        </div>
                                        <div class="form-group mt-0 col-md-4">
                                            <label>Phone:</label>
                                            <input type="text" name="seller_phone" class="form-control" value="{{$auction->seller_phone}}">
                                        </div>
                                        <div class="form-group mt-0 col-md-4">
                                            <label>Email:</label>
                                            <input type="text" name="seller_email" class="form-control" value="{{$auction->seller_email}}">
                                        </div>
                                    </div>
                                </div>
                            </div>
