  ...
  <div class="container p-4">
    ...
    <div class="card m-4">
      ...
      <div class="card-body">
        ...
        <form class="p-4 pt-0 mainform" action="{{ route('seller.add-counter-terms') }}" method="POST"
          ...
          <div class="wizard-step">
            <div class="form-group">
              <label class="fw-bold" for="timeframe">What is the timeframe offered to the agent in the Seller Agency
                Agreement?</label>
          ...
          <div class="wizard-step">
            @php
              $sellerCommission = [
                  ['name' => 'Yes', 'target' => '.propFeeYes', 'icon' => 'fa-regular fa-circle-check'],
                  ['name' => 'No', 'target' => '', 'icon' => 'fa-regular fa-circle-xmark'],
              ];
            @endphp
            <div class="form-group">
              <label class="fw-bold">Would the seller like to request that the agent contribute a portion of their
                commission towards the buyer's closing costs to further promote their property? </label>
              ...
              <div class="form-group  d-none">
                @php
                  $propFee = [
                      ...
                      ['name' => 'Other', 'target' => '.propFeeOther'],
                  ];
                @endphp
                <label class="fw-bold">What is the offered finder’s fee the tenant is willing to pay the agent for their
                ...
                <div class="form-group propFeeOther d-none">
                  <label class="fw-bold">What is the offered fee the tenant is willing to pay the agent for their
                    assistance in finding them a property?</label>
                  <input type="text" class="form-control has-icon" name="propFeeOther" data-icon="fa-solid fa-qrcode">
                </div>
              </div>
            </div>
          </div>
          <div class="wizard-step">
            ...
            @endphp
            <div class="form-group">
              <label class="fw-bold">Select the services that the seller requests from an agent:</label>
