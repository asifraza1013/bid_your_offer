  ...
  <div class="container p-4">
    ...
    <div class="card m-4">
      ...
      <div class="card-body">
        ...
        <form class="p-4 pt-0 mainform" action="{{ route('seller.update-counter-terms', $counter->id) }}" method="POST"
          ...
          <div class="wizard-step">
            <div class="form-group">
              <label for="listing_title" class="fw-bold">What is the timeframe offered to the agent in the Seller Agency
                Agreement?</label>
              <input type="text" name="timeframe" value="{{ $counter->timeframe }}" class="form-control has-icon"
                data-icon="fa-solid fa-qrcode" required value="">
            </div>
          </div>
          <div class="wizard-step">
            <div class="form-group">
              <label class="fw-bold" for="timeframe">What is the total commission being offered to the agent?</label>
              <input type="text" name="commission" value="{{ $counter->commission }}"
                class="form-control has-icon hide_arrow" data-icon="fa-solid fa-qrcode" required>
            </div>
          </div>
          <div class="wizard-step">
            @php
              $sellerCommission = [['name' => 'Yes', 'target' => '.propFeeYes', 'icon' => 'fa-regular fa-circle-check'], ['name' => 'No', 'target' => '', 'icon' => 'fa-regular fa-circle-xmark']];
            @endphp
            <div class="form-group">
              ...
              <select class="grid-picker" name="sellerCommission" required>
                <option value="">Select</option>
                @foreach ($sellerCommission as $item)
                  <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}"
                    {{ $item['name'] == $counter->sellerCommission ? 'selected' : '' }} class="card flex-row"
          ...
          <div class="wizard-step">
            ...
            <div class="form-group">
              ...
              <select class="grid-picker" name="services[]" multiple required>
                <option value="">Select</option>
              ...
              <div class="form-group  {{ $counter->other_services != '' ? 'd-block' : 'd-none' }} other_services">
