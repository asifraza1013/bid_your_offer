  ...
  <div class="container p-4">
    ...
    <div class="card m-4">
      ...
      <div class="card-body">
        ...
        <form class="p-4 pt-0 mainform" action="{{ route('landlord.update-counter-terms', $counter->id) }}" method="POST"
          ...
          <div class="wizard-step">
            <div class="form-group">
              <label class="fw-bold" for="timeframe">What is the total commission being offered to the listing
                agent?</label>
              <input type="text" name="commission" class="form-control has-icon hide_arrow"
                data-icon="fa-solid fa-qrcode" value="{{ $counter->commission }}" required>
            </div>
          </div>
          <div class="wizard-step">
            @php
            ...
            <div class="form-group {{ $counter->other_services != '' ? 'd-block' : 'd-none' }} other_services">
              ...
              <input type="text" name="other_services" id="other_services" value="{{ $counter->other_services }}"
          ...
          <div class="wizard-step">
            <div class="form-group">
              ...
              <textarea name="additional_details" class="form-control" rows="5">{{ $counter->additional_details }}</textarea>
            </div>
            <div class="form-group">
              <div class="container">
