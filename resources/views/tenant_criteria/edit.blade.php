        ...
        <form class="p-4 pt-0 mainform" action="{{ route('agent.tenant.criteria.auction.add') }}" method="POST"
          ...
          <div class="wizard-step" data-step="1">
            ...
            <div class="form-group">
              <table class="table table-bordered">
                ...
                <tbody>
                  <tr>
                    <td>
                      <input type="text" name="cities[]" value="{{$auction->get->cities[0]}}" placeholder="" data-type="cities" id="cities"
            ...
            <div class="form-group">
              <table class="table table-bordered">
                ...
                <tbody>
                  <tr>
                    <td><input type="text" name="counties[]" value="{{$auction->get->counties[0]}}" placeholder="" data-type="counties" id="counties"
            ...
            <div class="form-group">
              <table class="table table-bordered">
                ...
                <tbody>
                  <tr>
                    <td><input type="text" name="state[]" value="{{$auction->get->state[0]}}" placeholder="" data-type="state" id="state"
          ...
          <div class="wizard-step" data-step="2">
            ...
            <div class="form-group">
              ...
              <input type="date" name="listing_date" value="{{$listingDate}}" id="listing_date" class="form-control has-icon"
                data-icon="fa-regular fa-calendar-days" required>
            </div>

            <div class="form-group">
              <label class="fw-bold">Expiration Date:</label>
              <input type="date" name="expiration_date" value="{{$expirationDate}}" id="expiration_date" class="form-control has-icon"
                data-icon="fa-regular fa-calendar-days" required>
            </div>
          </div>
          ...
          <div class="wizard-step" data-step="4">
            <div class="form-group">
              ...
              <input type="text" name="titleListing" value="{{$auction->get->titleListing}}" id="" class="form-control has-icon"
              ...
              <select class="grid-picker" name="property_type" id="property_type"
                ...
                @foreach ($property_types as $row_pt)
                  <option value="{{ $row_pt['name'] }}" class="card flex-column" style="width:calc(24% - 10px);"
                    data-icon='<i class="fa-solid fa-hotel"></i>' {{$auction->get->property_type == $row_pt['name'] ? 'selected' : ''}}>
                    {{ $row_pt['name'] }}
                  </option>
                @endforeach
              </select>
          ...
          <div class="wizard-step" data-step="6">
            <div class="form-group">
              ...
              <select class="grid-picker" name="leaseProp" id="bedrooms" style="" required>
                ...
                @foreach ($propsRes as $item)
                  <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}" class="card"
                    style="width:calc(33.33% - 10px );" data-icon='<i class="fa-solid fa-hotel"></i>'  {{$auction->get->leaseProp == $item['name'] ? 'selected' : ''}}>
                    {{ $item['name'] }}
                  </option>
                @endforeach
              </select>
              <div class="form-group main singleRoomRes d-none">
                ...
                <input type="text" class="form-control has-icon" value="{{$auction->get->leasePropOther}}" data-icon="fa-solid fa-ruler-combined"
          ...
          <div class="wizard-step" data-step="7">
            <span class="resFields">
              ...
              <div class="form-group main other_prop_conditionRes d-none">
                <label class="fw-bold">Acceptable Property Conditions: </label>
                <input type="text" name="propsOther" value="{{$auction->get->propsOther}}" id="propsOther" class="form-control has-icon  "
          ...
          <div class="wizard-step" data-step="8">
            <div class="form-group">
              ...
              <input type="number" step="0.01" value="{{$auction->get->monthly_price}}" placeholder="0.00" name="monthly_price" id="monthly_price"
              ...
              <div class="form-group ">
                ...
                <select class="grid-picker" name="leaseLength[]" id="" style="justify-content: flex-start;"
                  ...
                  @foreach ($leaseLenRes as $item)
                    <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}" class="card flex-row"
                      style="width:calc(50% - 10px);" data-icon='<i class="fa-regular fa-circle-check"></i>' {{in_array($item['name'] , $auction->get->leaseLength) ? 'selected' : ''}}>
                      {{ $item['name'] }}
                    </option>
                  @endforeach
                </select>
              </div>
              <div class="form-group main leaseOtherRes d-none">
                <label class="fw-bold">Offered Lease Length: </label>
                <input type="text" name="leaseOther" value="{{$auction->get->leaseOther}}" id="propsOther" class="form-control has-icon  "
                  data-icon="fa-regular fa-calendar-days" data-msg-required="Property Condition" placeholder="" required>
              </div>
            </span>
            <div class="form-group">
                <?php
                    $idealDateTime = $auction->listing_date;
                    $idealDate = (new DateTime($idealDateTime))->format('Y-m-d');
                ?>
              <label class="fw-bold">Offered Lease Start Date:</label>
              <input type="date" name="idealDate" value="{{$idealDate}}" id="propsOther" class="form-control has-icon  "
                data-icon="fa-regular fa-calendar-days" data-msg-required="Property Condition" placeholder="" required>
            </div>
          </div>
              ...
              <select class="grid-picker" name="bedrooms" id="bedrooms" style="" required>
                ...
                @foreach ($bedrooms as $item)
                  <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}" class="card flex-column"
                    style="width:calc(9% - 10px);" data-icon='<i class="fa-solid fa-bed"></i>' {{$auction->get->bedrooms == $item['name'] ? 'selected' : ''}}>
                    {{ $item['name'] }}
                  </option>
                @endforeach
              </select>
            </div>
            <div class="form-group main custom_bedrooms d-none">
              <label class="fw-bold">Minimum Bedrooms Needed:</label>
              <input type="number" name="custom_bedrooms" value="{{$auction->get->custom_bedrooms}}" id="custom_bedrooms" class="form-control has-icon"
          ...
          <div class="wizard-step" data-step="10">
            ...
            <div class="form-group">
              ...
              <select class="grid-picker" name="bathrooms" id="bathrooms" style="" required>
                ...
                @foreach ($bathrooms as $item)
                  <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}" class="card flex-column"
                    style="width:calc(10% - 10px);" data-icon='<i class="fa-solid fa-bath"></i>' {{$auction->get->bathrooms == $item['name'] ? 'selected' : ''}}>
                    {{ $item['name'] }}
                  </option>
                @endforeach
              </select>
            ...
            <div class="form-group main custom_bathrooms d-none">
              <label class="fw-bold">Minimum Bathrooms Needed: </label>
              <input type="number" name="custom_bathrooms" value="{{$auction->get->custom_bathrooms}}" id="custom_bathrooms" class="form-control has-icon"
          ...
          <div class="wizard-step" data-step="11">
            <span class="resFieldss">
              <div class="form-group">
                ...
                <input type="number" name="minimum_sqft_needed" value="{{$auction->get->minimum_sqft_needed}}" id="minimum_sqft_needed"
                ...
                <select class="grid-picker" name="total_acreage" id="total_acreage"
                  ...
                  @foreach ($acreageRes as $item)
                    <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}"
                      ...
                      data-icon='<i class="fa-solid fa-ruler-combined"></i>' {{$auction->get->total_acreage == $item['name'] ? 'selected' : ''}}>
                      {{ $item['name'] }}
                    </option>
                  @endforeach
                </select>
              ...
              <div class="form-group ">
                ...
                <select class="grid-picker" name="garageParkingOpt" id="garageParkingComm"
                  ...
                  @foreach ($garageParkingComm as $item)
                    <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}" class="card flex-column"
                      style="width:calc(33.3% - 10px);" data-icon='<i class="{{ $item['icon'] }}"></i>' {{$auction->get->garageParkingOpt == $item['name'] ? 'selected' : ''}}>
                      {{ $item['name'] }}
                    </option>
                  @endforeach
                </select>
                <div class="form-group " id="garageParkingOpt" style="display: none;">
                  ...
                  <div class="form-group main garageOther d-none">
                    ...
                    <input type="text" name="garageOther" value="{{$auction->get->garageOther}}" id="minimum_sqft_needed" class="form-control has-icon"
              ...
              <div class="form-group">
                ...
                <select class="grid-picker" name="carport" id="carport" style="justify-content: flex-start;"
                  ...
                  @foreach ($yes_or_nos_opt as $item)
                    <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}" class="card flex-row"
                      style="width:calc(33.3% - 10px);" data-icon='<i class="{{ $item['icon'] }}"></i>' {{$auction->get->carport == $item['name'] ? 'selected' : ''}}>
                      {{ $item['name'] }}
                    </option>
                  @endforeach
                </select>
              ...
              <div class="form-group carport_opt">
                ...
                <select class="grid-picker" name="carport_opt" id="carport_opt" style="justify-content: flex-start;"
                  ...
                  @foreach ($carport_options as $item)
                    <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}" class="card flex-row"
                      style="width:calc(15% - 10px);" data-icon="<i class='fa-solid fa-warehouse'></i>" {{$auction->get->carport_opt == $item['name'] ? 'selected' : ''}}>
                      {{ $item['name'] }}
                    </option>
                  @endforeach
                </select>
              </div>
              <div class="form-group main custom_carport d-none">
                <label class="fw-bold">Carport Spaces Needed:</label>
                <input type="number" name="custom_carport" value="{{$auction->get->custom_carport}}" id="custom_carport" class="form-control has-icon"
                  data-icon="fa-solid fa-warehouse" required>
              </div>
              <div class="form-group">
                ...
                <select class="grid-picker" name="garage" id="garage" style="justify-content: flex-start;"
                  ...
                  @foreach ($yes_or_nos_opt as $item)
                    <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}" class="card flex-row"
                      style="width:calc(33.3% - 10px);" data-icon='<i class="{{ $item['icon'] }}"></i>' {{$auction->get->garage == $item['name'] ? 'selected' : ''}}>
                      {{ $item['name'] }}
                    </option>
                  @endforeach
                </select>
              ...
              <div class="form-group garage_opt">
                ...
                <select class="grid-picker" name="garage_opt" id="garage_opt" style="justify-content: flex-start;"
                  ...
                  @foreach ($garage_options as $item)
                    <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}" class="card flex-row"
                      style="width:calc(15% - 10px);" data-icon="<i class='fa-solid fa-warehouse'></i>" {{$auction->get->garage_opt == $item['name'] ? 'selected' : ''}}>
                      {{ $item['name'] }}
                    </option>
                  @endforeach
                </select>
              </div>
              <div class="form-group main custom_garage d-none">
                <label class="fw-bold">Garage Spaces Needed:</label>
                <input type="number" name="custom_garage" value="{{$auction->get->custom_garage}}" id="custom_garage" class="form-control has-icon"
                  data-icon="fa-solid fa-warehouse" required>
              </div>
            </div>
          </div>
              ...
              <div class="form-group ">
                ...
                <select class="grid-picker" name="has_water_view" id="waterViewRes"
                  ...
                  @foreach ($waterViewOptRes as $item)
                    <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}" class="card flex-row"
                      style="width:calc(33.3% - 10px);" data-icon='<i class="{{ $item['icon'] }}"></i>' {{$auction->get->has_water_view == $item['name'] ? 'selected' : ''}}>
                      {{ $item['name'] }}
                    </option>
                  @endforeach
                </select>
                ...
                <select class="grid-picker" name="water_view[]" id="water_view" style="justify-content: flex-start;"
                  ...
                  @foreach ($waterViewRes as $item)
                    <option value="{{ $item['name'] }}" data-icon="<i class='fa-regular fa-circle-check'></i>"
                      data-target="{{ $item['target'] }}" class="card flex-row" style="width:calc(33.3% - 10px);" {{ in_array($item['name'], $auction->get->water_view) ? 'selected' : '' }}>
                      {{ $item['name'] }}
                    </option>
                  @endforeach
                </select>
              ...
              <div class="form-group">
                ...
                <select class="grid-picker" name="has_water_extra" id="waterExtraRes"
                  ...
                  @foreach ($waterExtrasOptRes as $item)
                    <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}" class="card flex-row"
                      style="width:calc(33.3% - 10px);" data-icon='<i class="{{ $item['icon'] }}"></i>' {{ $item['name'] == $auction->get->has_water_extra ? 'selected' : '' }}>
                      {{ $item['name'] }}
                    </option>
                  @endforeach
                </select>
              ...
              <div class="form-group" id="waterExtraResOpt" style="display: none;">
                ...
                <select class="grid-picker" name="water_extras[]" id="water_extras"
                  ...
                  @foreach ($waterExtraRes as $item)
                    <option value="{{ $item['name'] }}" data-icon="<i class='fa-regular fa-circle-check'></i>"
                      data-target="{{ $item['target'] }}" class="card flex-row" style="width:calc(33.3% - 10px);" {{in_array($item['name'], $auction->get->water_extras) ? 'selected' : '' }}>
                      {{ $item['name'] }}
                    </option>
                  @endforeach
                </select>
                ...
                <select class="grid-picker" name="waterFrontageOpt" id="waterFrontageRes"
                  ...
                  @foreach ($waterfrontageOptRes as $item)
                    <option value="{{ $item['name'] }}" data-icon='<i class="{{ $item['icon'] }}"></i>'
                      data-target="{{ $item['target'] }}" class="card flex-row" style="width:calc(33.3% - 10px);" {{ $item['name'] == $auction->get->waterFrontageOpt ? 'selected' : '' }}>
                      {{ $item['name'] }}
                    </option>
                  @endforeach
                </select>
              ...
              <div class="form-group" id="waterFrontageResOpt" style="display: none;">
                ...
                <select class="grid-picker" name="waterFrontage[]" id="has_water_fontage"
                  ...
                  @foreach ($waterFrontageOptCommercial as $item)
                    <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}" class="card flex-row"
                      style="width:calc(33.3% - 10px);" data-icon="<i class='fa-regular fa-circle-check'></i>" {{ in_array($item['name'], $auction->get->waterFrontage) ? 'selected' : '' }}>
                      {{ $item['name'] }}
                    </option>
                  @endforeach
                </select>
              ...
              <div class="form-group">
                ...
                <select class="grid-picker" name="waterAccessOpt" id="waterAccessRes"
                  ...
                  @foreach ($waterAccessOptRes as $item)
                    <option value="{{ $item['name'] }}" data-icon="<i class='{{ $item['icon'] }}'></i>"
                      data-target="{{ $item['target'] }}" class="card flex-row" style="width:calc(33.3% - 10px);" {{ $item['name'] == $auction->get->waterAccessOpt ? 'selected' : '' }}>
                      {{ $item['name'] }}
                    </option>
                  @endforeach
                </select>
              ...
              <div class="form-group" id="waterAccessResOpt" style="display: none;">
                ...
                <select class="grid-picker" name="water_access[]" id="" style="justify-content: flex-start;"
                  ...
                  @foreach ($waterAccessRes as $item)
                    <option value="{{ $item['name'] }}" data-icon="<i class='fa-regular fa-circle-check'></i>"
                      data-target="{{ $item['target'] }}" class="card flex-row" style="width:calc(33.3% - 10px);" {{ in_array($item['name'], $auction->get->water_access) ? 'selected' : '' }}>
                      {{ $item['name'] }}
                    </option>
                  @endforeach
                </select>
              ...
              <div class="form-group ">
                ...
                <select class="grid-picker" name="has_water_view" id="waterViewComm"
                  ...
                  @foreach ($waterViewOptComm as $item)
                    <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}" class="card flex-row"
                      style="width:calc(33.3% - 10px);" data-icon='<i class="{{ $item['icon'] }}"></i>' {{ $item['name'] == $auction->get->has_water_view ? 'selected' : '' }}>
                      {{ $item['name'] }}
                    </option>
                  @endforeach
                </select>
                ...
                <select class="grid-picker" name="water_view[]" id="water_view" style="justify-content: flex-start;"
                  ...
                  @foreach ($water_views as $water_view)
                    <option value="{{ $water_view['name'] }}" data-icon="<i class='fa-regular fa-circle-check'></i>"
                      ...
                      style="width:calc(33.3% - 10px);" {{in_array($item['name'], $auction->get->water_view) ? 'selected' : '' }}>
                      {{ $water_view['name'] }}
                    </option>
                  @endforeach
                </select>
                ...
                <select class="grid-picker" name="water_access[]" id="water_access"
                  ...
                  @foreach ($waterAccessComm as $water_access1)
                    <option value="{{ $water_access1['name'] }}"
                      ...
                      style="width:calc(33.3% - 10px);" {{ in_array($water_access1['name'], $auction->get->water_access) ? 'selected' : '' }}>
                      {{ $water_access1['name'] }}
                    </option>
                  @endforeach
                </select>
              ...
              <select class="grid-picker" name="has_dock" id="hasDock"
                  ...
                  @foreach ($dockRes as $item)
                      <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}"
                          ...
                          data-icon='<i class="{{ $item['icon'] }}"></i>' {{ $auction->get->has_dock == $item['name'] ? 'selected' : '' }}>
                          {{ $item['name'] }}
                      </option>
                  @endforeach
              </select>
                  ...
                  <select class="grid-picker" name="dock[]" id="dock"
                      ...
                      @foreach ($dockRes as $item)
                          <option value="{{ $item['name'] }}"
                              ...
                              style="width:calc(33.3% - 10px);" {{in_array($item['name'], $auction->get->dock) ? 'selected' : '' }}>
                              {{ $item['name'] }}
                          </option>
                      @endforeach
                  </select>
                ...
                <div class="form-group">
                  ...
                  <select class="grid-picker" name="viewOpt" id="viewOptionComm" style="justify-content: flex-start;">
                    ...
                    @foreach ($viewOptComm as $item)
                      <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}" class="card flex-row"
                        style="width:calc(33.3% - 10px);" data-icon="<i class='{{ $item['icon'] }}'></i>" {{$auction->get->viewOpt == $item['name'] ? 'selected' : '' }}>
                        {{ $item['name'] }}
                      </option>
                    @endforeach
                  </select>
                  ...
                  <select class="grid-picker" name="viewReference[]" id=""
                    ...
                    @foreach ($viewReferenceComm as $item)
                      <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}"
                        ...
                        style="width:calc(33.3% - 10px);" {{in_array($item['name'], $auction->get->viewReference) ? 'selected' : '' }}>
                        {{ $item['name'] }}
                      </option>
                    @endforeach
                  </select>
                  <div class="form-group main viewReferenceCommercialOther d-none">
                    <label class="fw-bold">View Preference Needed:</label>
                    <input type="text" name="viewReferenceOther" value="{{$auction->get->viewReferenceOther}}" class="form-control has-icon"
              ...
              <div class="form-group ">
                ...
                <select class="grid-picker" name="total_acreage" id="total_acreage"
                  ...
                  @foreach ($acreageRes as $item)
                    <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}"
                      class="card flex-column" style="width:calc(25% - 10px);"
                      data-icon='<i class="fa-solid fa-ruler-combined"></i>' {{ $item['name'] == $auction->get->total_acreage ? 'selected' : '' }}>
                      {{ $item['name'] }}
                    </option>
                  @endforeach
                </select>
            ...
            <div class="form-group" id="pool">
              ...
              <select class="grid-picker" name="pool" id="pool" style="justify-content: flex-start;" required>
                ...
                @foreach ($poolNeeded as $item)
                  <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}" class="card flex-row"
                    style="width:calc(33.3% - 10px);" data-icon='<i class="{{ $item['icon'] }}"></i>' {{ $item['name'] == $auction->get->pool ? 'selected' : '' }}>
                    {{ $item['name'] }}
                  </option>
                @endforeach
              </select>
            </div>
            <div class="form-group main poolNeededYes d-none">
              @php
                $poolNeededYes = [
                    [
                        'name' => 'Private',
              ...
              <select class="grid-picker" name="poolNeededOpt" id="pool" style="justify-content: flex-start;"
                ...
                @foreach ($poolNeededYes as $item)
                  <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}" class="card flex-row"
                    style="width:calc(33.3% - 10px);" data-icon='<i class="{{ $item['icon'] }}"></i>' {{ $item['name'] == $auction->get->poolNeededOpt ? 'selected' : '' }}>
                    {{ $item['name'] }}
                  </option>
                @endforeach
              </select>
            </div>
            <div class="resFieldss">
              <div class="form-group">
                @php
                  $viewOptRes = [
                      ['name' => 'Yes', 'target' => '.viewOptYes', 'icon' => 'fa-regular fa-circle-check'],
                ...
                <div class="form-group">
                  ...
                  <select class="grid-picker" name="viewOpt" id="viewRes" style="justify-content: flex-start;">
                    ...
                    @foreach ($viewOptRes as $item)
                      <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}" class="card flex-row"
                        style="width:calc(33.3% - 10px);" data-icon="<i class='{{ $item['icon'] }}'></i>" {{ $item['name'] == $auction->get->viewOpt ? 'selected' : '' }}>
                        {{ $item['name'] }}
                      </option>
                    @endforeach
                  </select>
                ...
                <div class="form-group" id="viewOptRes" style="display:none;">
                  ...
                  <div class="form-group main viewReferenceResOther d-none">
                    <label class="fw-bold">View Preference Needed:</label>
                    <input type="text" name="viewReferenceOther" value="{{$auction->get->viewReferenceOther}}" class="form-control has-icon"
                      data-icon="fa-regular fa-circle-check" required>
                  </div>
            ...
            <div class="form-group">
              ...
              <select class="grid-picker" name="is_tenant_eligible" id="is_tenant_eligible"
                ...
                @foreach ($yes_or_nos as $item)
                  <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}" class="card flex-row"
                    style="width:calc(33.3% - 10px);" data-icon='<i class="{{ $item['icon'] }}"></i>' {{ $auction->get->is_tenant_eligible == $item['name'] ? 'selected' : '' }}>
                    {{ $item['name'] }}
                  </option>
                @endforeach
              </select>
          ...
          <div class="wizard-step" data-step="20">
            <div class="form-group">
              ...
              <textarea name="description_buyer_specific" id="buyer_specific_requirements" class="form-control" cols="15"
                rows="5" required>{{$auction->get->description_buyer_specific}}</textarea>
            </div>
          </div>
            ...
            <div class="form-group ">
              ...
              <select class="grid-picker" name="any_non_negotiable_factors" id="any_non_negotiable_factors"
                ...
                @foreach ($negotiableOpt as $item)
                  <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}" class="card flex-row"
                    style="width:calc(33.3% - 10px);" data-icon='{{ $item['icon'] }}' {{ $auction->get->any_non_negotiable_factors == $item['name'] ? 'selected' : '' }}>
                    {{ $item['name'] }}
                  </option>
                @endforeach
              </select>
              <div class="form-group main negotiableOptYesRes d-none">
                <div class="resFieldss">
                  @php
                    $negotiableRes = [
                        ['name' => 'Garage', 'target' => ''],
                  ...
                  <select class="grid-picker" name="negotiable[]" id="any_non_negotiable_factors"
                    ...
                    @foreach ($negotiableRes as $item)
                      <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}" class="card flex-row"
                        style="width:calc(33.3% - 10px);" data-icon='<i class="fa-regular fa-circle-check"></i>' {{in_array($item['name'], $auction->get->negotiable) ? 'selected' : ''}}>
                        {{ $item['name'] }}
                      </option>
                    @endforeach
                  </select>
                  <div class="form-group main negotiableOtherRes d-none">
                    <label class="fw-bold">What are the non-negotiable amenities or property features that the tenant will
                      not accept for a property?</label>
                    <input type="text" name="negotiableOther" value="{{$auction->get->negotiableOther}}" id="" class="form-control has-icon"
                      data-icon="fa-regular fa-circle-check" required>
                  </div>
                </div>
                <div class="commercialFieldss">
                  @php
                    $negotiableCom = [
                        ...
                        ['name' => 'Other', 'target' => '.negotiableOtherCom'],
                    ];
                  @endphp
                  <label class="fw-bold">What are the non-negotiable amenities or property features that the tenant will
                    not accept for a property?</label>
                  ...
                  <div class="form-group main negotiableOtherCom d-none">
                    <label class="fw-bold">What are the non-negotiable amenities or property features that the tenant will
                      not accept for a property?</label>
                    <input type="text" name="negotiableOther" value="{{$auction->get->negotiableOther}}" id="" class="form-control has-icon"
                      data-icon="fa-regular fa-circle-check" required>
          ...
          <div class="wizard-step" data-step="22">
            ...
            <span class="resFieldss">
                ...
                <select class="grid-picker" name="has_pets" id="has_pets" style="justify-content: flex-start;"
                  ...
                  @foreach ($yes_or_nos as $item)
                    ...
                    <option value="{{ $item['name'] }}" data-target="{{ $target }}" class="card flex-row"
                      style="width:calc(33.3% - 10px);" data-icon='<i class="{{ $item['icon'] }}"></i>' {{$auction->get->has_pets == $item['name'] ? 'selected' : ''}}>
                      {{ $item['name'] }}
                    </option>
                  @endforeach
                </select>
              </div>
              <div class="pets_info main d-none">
                <div class="form-group">
                  <label class="fw-bold">How many pets does the tenant have?</label>
                  <input type="text" name="totalPets" value="{{$auction->get->totalPets}}" id="type_of_pet" class="form-control has-icon"
                    data-icon="fa-solid fa-dog" required>
                </div>
                <div class="form-group">
                  <label class="fw-bold">What type of pet(s) does the tenant have?</label>
                  <input type="text" name="petType" value="{{$auction->get->petType}}" id="pets_bread" class="form-control has-icon"
                    data-icon="fa-solid fa-dog" required>
                </div>
                <div class="form-group">
                  <label class="fw-bold">What breed(s) are the pet(s)?</label>
                  <input type="text" name="petBreed" value="{{$auction->get->petBreed}}" id="total_pets" class="form-control has-icon"
                    data-icon="fa-solid fa-dog" required>
                </div>
                <div class="form-group">
                  <label class="fw-bold">What is the weight of the pet(s)?</label>
                  <input type="text" name="petWeight" value="{{$auction->get->petWeight}}" id="total_pets" class="form-control has-icon"
                    data-icon="fa-solid fa-dog" required>
                </div>
              </div>
              <div class="form-group">
                <label class="fw-bold">How many people will be occupying the property:</label>
                <input type="number" name="how_many_occupying" value="{{$auction->get->how_many_occupying}}" class="form-control has-icon"
              ...
              <div class="form-group">
                ...
                <select class="grid-picker" name="tenant_credit_score" id="any_non_negotiable_factors"
                  ...
                  @foreach ($scoreRating as $item)
                    <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}" class="card flex-row"
                      style="width:calc(25% - 10px);" data-icon='<i class="fa-regular fa-circle-check"></i>' {{$auction->get->tenant_credit_score == $item['name'] ? 'selected' : '' }}>
                      {{ $item['name'] }}
                    </option>
                  @endforeach
                </select>
              ...
              <div class="form-group">
                ...
                <input type="number" step="0.01" value="{{$auction->get->monthly_household_income}}" placeholder="0.00" min="1"
              ...
              <div class="form-group">
                ...
                <select name="convicted" id="convicted" class="grid-picker" style="justify-content: flex-start;">
                  ...
                  @foreach ($convictedRes as $item)
                    <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}"
                      class="card flex-column" style="width:calc(33.3% - 10px);"
                      data-icon='<i class="{{ $item['icon'] }}"></i>' {{$auction->get->convicted == $item['name'] ? 'selected' : '' }}>
                      {{ $item['name'] }}
                    </option>
                  @endforeach
                </select>
                <div class="form-group main custom_convictedRes d-none">
                  <label class="fw-bold" for="custom_convicted">Explain when and what for:</label>
                  <input type="text" name="custom_convicted" value="{{$auction->get->custom_convicted}}" id="custom_convicted"
              ...
              <div class="form-group">
                ...
                <select name="evicted" id="evicted" class="grid-picker" style="justify-content: flex-start;">
                  ...
                  @foreach ($evictedRes as $item)
                    <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}"
                      class="card flex-column" style="width:calc(33.3% - 10px);"
                      data-icon='<i class="{{ $item['icon'] }}"></i>' {{$auction->get->evicted == $item['name'] ? 'selected' : '' }}>
                      {{ $item['name'] }}
                    </option>
                  @endforeach
                </select>
                <div class="form-group main custom_evictedRes d-none">
                  <label class="fw-bold" for="custom_evicted_why">Explain when and why:</label>
                  <input type="text" name="custom_evicted" value="{{$auction->get->custom_evicted}}" id="custom_evicted" placeholder=""
            ...
            <span class="commercialFieldss">
              ...
              <div class="form-group">
                ...
                <select class="grid-picker" name="tenant_credit_score" id="any_non_negotiable_factors"
                  ...
                  @foreach ($scoreRatingComm as $item)
                    <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}" class="card flex-row"
                      style="width:calc(25% - 10px);" data-icon='<i class="fa-regular fa-circle-check"></i>' {{$item['name'] == $auction->get->tenant_credit_score ? 'selected' : ''}}>
                      {{ $item['name'] }}
                    </option>
                  @endforeach
                </select>
              ...
              <div class="form-group">
                ...
                <input type="number" step="0.01" placeholder="0.00" min="1"
                  name="monthly_household_income" value="{{$auction->get->monthly_household_income}}" id="monthly_household_income" class="form-control has-icon"
                  data-icon="fa-solid fa-dollar">
              </div>
              <div class="form-group">
                <label class="fw-bold">
                ...
                <select name="convicted" id="convicted" class="grid-picker" style="justify-content: flex-start;">
                  ...
                  @foreach ($convictedCommercial as $item)
                    <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}"
                      class="card flex-column" style="width:calc(33.3% - 10px);"
                      data-icon='<i class="{{ $item['icon'] }}" style="font-size:24px;"></i>' {{ $item['name'] == $auction->get->convicted ? 'selected' : '' }}>
                      {{ $item['name'] }}
                    </option>
                  @endforeach
                </select>
                <div class="form-group main custom_convictedCommercial d-none">
                  <label class="fw-bold" for="custom_convicted">Explain when and what for:</label>
                  <input type="text" name="custom_convicted" value="{{$auction->get->custom_evicted}}" id="custom_convicted"
                    placeholder="" class="form-control has-icon"
                    data-icon="fa-regular fa-circle-check" required>
                </div>
              </div>
              <div class="form-group">
                ...
                <select name="evicted" id="evicted" class="grid-picker" style="justify-content: flex-start;">
                  ...
                  @foreach ($evictedCommercial as $item)
                    <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}"
                      class="card flex-column" style="width:calc(33.3% - 10px);"
                      data-icon='<i class="{{ $item['icon'] }}" style="font-size:24px;"></i>' {{ $item['name'] == $auction->get->evicted ? 'selected' : '' }}>
                      {{ $item['name'] }}
                    </option>
                  @endforeach
                </select>
                <div class="form-group main custom_evictedCommercial d-none">
                  <label class="fw-bold" for="custom_evicted_why">Explain when and why:</label>
                  <input type="text" name="custom_evicted" value="{{$auction->get->custom_evicted}}" id="custom_evicted" placeholder=""
                    class="form-control has-icon" data-icon="fa-regular fa-circle-check" required>
                </div>
          ...
          <div class="wizard-step" data-step="23">
            ...
            <div class="form-group">
              ...
              <select name="compensateOpt" id="lease_violations" class="grid-picker"
                ...
                @foreach ($violationsRes as $item)
                  <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}"
                    class="card flex-column" style="width:calc(33.3% - 10px);"
                    data-icon='<i class="{{ $item['icon'] }}" ></i>' {{ $item['name'] == $auction->get->compensateOpt ? 'selected' : '' }}>
                    {{ $item['name'] }}
                  </option>
                @endforeach
              </select>
              <div class="form-group main compensate d-none">
                ...
                <select name="compensateOtherOpt" id="lease_violations" class="grid-picker"
                  ...
                  @foreach ($compensateOther as $item)
                    <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}"
                      class="card flex-column" style="width:calc(33.3% - 10px);"
                      data-icon='<i class="fa-regular fa-circle-check" ></i>' {{ $item['name'] == $auction->get->compensateOtherOpt ? 'selected ' : '' }}>
                      {{ $item['name'] }}
                    </option>
                  @endforeach
                </select>
                <div class="form-group main compensateOther d-none">
                  <label class="fw-bold" for="custom_evicted">What is the finder's fee that the tenant is offering to
                    pay an agent if they find a suitable property to lease?</label>
                  <input type="text" name="compensateOther" value="{{$auction->get->compensateOther}}" class="form-control has-icon"
            ...
            <div class="form-group">
              <label class="fw-bold">
                Does the tenant have a real estate agent representing them?
              </label>
              @php
                $representedRes = [
              ...
              @endphp
              <select name="represented" id="represented" class="grid-picker"
                style="justify-content: flex-start;">
                <option value=""></option>
                @foreach ($representedRes as $item)
                  <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}"
                    class="card flex-column" style="width:calc(33.3% - 10px);"
                    data-icon='<i class="{{ $item['icon'] }}" ></i>' {{ $item['name'] == $auction->get->represented ? 'selected ' : '' }}>
                    {{ $item['name'] }}
                  </option>
                @endforeach
              </select>
              <div class="form-group represented d-none">
                <label class="fw-bold" for="custom_evicted">Does the tenant request that the landlord pay the tenant’s agent commission?</label>
                @php
                  // $representedOther = [
                  //     ['name' => '1 month’s rent', 'target' => ''],
                  //     ['name' => '50% of one month’s rent', 'target' => ''],
                ...
                @endphp
                <select name="agentCommissionRequested" id="representedRes" class="grid-picker"
                  style="justify-content: flex-start;">
                  <option value=""></option>
                  @foreach ($representedOther as $item)
                    <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}"
                      class="card flex-column" style="width:calc(33.3% - 10px);"
                      data-icon='<i class="fa-regular fa-circle-check" ></i>' {{ $item['name'] == $auction->get->agentCommissionRequested ? 'selected ' : '' }}>
                      {{ $item['name'] }}
                    </option>
                  @endforeach
                </select>
                <div class="form-group representedYesOpt d-none">
                  <label class="fw-bold" for="custom_evicted">What compensation is the tenant requesting the landlord to pay to the tenant’s agent?</label>
                  @php
                    $representedOtherOpt = [
                        ['name' => '1 month’s rent', 'target' => ''],
                        ['name' => '50% of one month’s rent', 'target' => ''],
                  ...
                  @endphp
                  <select name="agentCompensationAmountReq" id="representedResYes" class="grid-picker"
                    style="justify-content: flex-start;">
                    <option value=""></option>
                    @foreach ($representedOtherOpt as $item)
                      <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}"
                        class="card flex-column" style="width:calc(33.3% - 10px);"
                        data-icon='<i class="fa-regular fa-circle-check" ></i>' {{ $item['name'] == $auction->get->agentCompensationAmountReq ? 'selected ' : '' }}>
                        {{ $item['name'] }}
                      </option>
                    @endforeach
                  </select>
                  <div class="form-group main compensateReqOther d-none">
                    <label class="fw-bold" for="custom_evicted">What compensation is the tenant requesting the landlord to pay to the tenant’s agent?</label>
                    <input type="text" name="agentCompensationAmountReqOther" value="{{$auction->get->agentCompensationAmountReqOther}}" class="form-control has-icon"
                      data-icon="fa-regular fa-circle-check" required>
                  </div>
                </div>
                <div class="form-group main representedNoOpt d-none">
                  <label class="fw-bold" for="custom_evicted">Would the tenant be willing to pay an agent's commission if the landlord does not agree to
                    cover it, for bringing a property to the tenant that they end up leasing?</label>
                  @php
                    // $representedOtherOpt = [
                    //     ['name' => '1 month’s rent', 'target' => ''],
                    //     ['name' => '50% of one month’s rent', 'target' => ''],
                  ...
                  @endphp
                  <select name="tenantPaysTheAgent" id="representedResYes" class="grid-picker"
                    style="justify-content: flex-start;">
                    <option value=""></option>
                    @foreach ($tenantPaysOther as $item)
                      <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}"
                        class="card flex-column" style="width:calc(33.3% - 10px);"
                        data-icon='<i class="fa-regular fa-circle-check" ></i>' {{ $item['name'] == $auction->get->tenantPaysTheAgent ? 'selected ' : '' }}>
                        {{ $item['name'] }}
                      </option>
                    @endforeach
                  </select>
                  <div class="form-group main tenantPaysYesOpt d-none">
                    <label class="fw-bold" for="custom_evicted">What compensation is the tenant requesting the landlord to pay to the tenant’s agent?</label>
                    @php
                      $tenantPaysOtherOpt = [
                        ['name' => '1 month’s rent', 'target' => ''],
                        ...
                        ['name' => '6% of the value of the lease', 'target' => ''],
                        ['name' => 'Negotiable', 'target' => ''],
                        ['name' => 'Other', 'target' => '.tenantPayAmount'],
                      ];
                    @endphp
                    <select name="tenantPaysAmount" id="representedResYes" class="grid-picker"
                      style="justify-content: flex-start;">
                      <option value=""></option>
                      @foreach ($tenantPaysOtherOpt as $item)
                        <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}"
                          class="card flex-column" style="width:calc(33.3% - 10px);"
                          data-icon='<i class="fa-regular fa-circle-check" ></i>' {{ $item['name'] == $auction->get->tenantPaysAmount ? 'selected ' : '' }}>
                          {{ $item['name'] }}
                        </option>
                      @endforeach
                    </select>
                    <div class="form-group main tenantPayAmount d-none">
                      <label class="fw-bold" for="custom_evicted">What compensation is the tenant willing to offer to an agent?</label>
                      <input type="text" name="tenantPaysAmountOther" value="{{$auction->get->tenantPaysAmountOther}}" class="form-control has-icon"
                        data-icon="fa-solid fa-ruler-combined" required>
                    </div>
                  </div>
                </div>
            ...
            <div class="form-group row">
              <div class="form-group col-md-6">
                ...
                <input type="text" name="agent_brokerage" id="agent_brokerage" placeholder=""
                  ...
                  value="{{ $auction->get->agent_brokerage }}" required>
              </div>
              <div class="form-group col-md-6">
                ...
                <input type="text" name="agent_license_no" id="agent_license_no" placeholder=""
                  ...
                  value="{{ $auction->get->agent_license_no }}" required>
              </div>
            </div>
            @endif
            <div class="form-group row">
              ...
              <div class="form-group col-md-6">
                ...
                <input type="text" name="agent_mls_id" id="agent_mls_id" placeholder=""
                  class="form-control has-icon" data-icon="fa-solid fa-id-card-clip" value="{{ $auction->get->agent_mls_id }}"
                  required>
              </div>
              @endif
              <div class="form-group col-md-6">
                ...
                @else
                  <label class="fw-bold">Listed By: Tenant</label>
                @endif
...
@push('scripts')
      ...
      init: function() {
        ...
        $('.wizard-step-next').click(function(e) {
          ...
          if (v.form()) {
            if ($('.wizard-step.active').next().is('.wizard-step')) {
              ...
              console.log(StepWizard.currentStep)
              if(StepWizard.currentStep == 11 && property_type == 'Residential Property') {
                StepWizard.nextStep = 13;
                StepWizard.backStep = 11;
              }else if(StepWizard.currentStep == 14 && property_type == 'Residential Property') {
              ...
              } else if (StepWizard.currentStep == 8 && property_type == 'Commercial Property') {
        ...
        $('.wizard-step-back').click(function(e) {
          if ($('.wizard-step.active').prev().is('.wizard-step')) {
            ...
            // }
            if (StepWizard.currentStep == 13 && property_type == 'Residential Property') {
              StepWizard.backStep = 11;
              StepWizard.nextStep = 13;
            }else if (StepWizard.currentStep == 16 && property_type == 'Residential Property') {
              StepWizard.backStep = 14;
              StepWizard.nextStep = 16;
            }else if (StepWizard.currentStep == 19 && property_type == 'Commercial Property') {
              StepWizard.backStep = 14;
              StepWizard.nextStep = 19;
            } else if (StepWizard.currentStep == 10 && property_type == 'Commercial Property') {
              StepWizard.nextStep = 10;
              StepWizard.backStep = 8;
            } else {
  ...
  <script>
    ...
    $('#hasDock').change(function() {
      //Disply and hide a div
      ($(this).val().includes('Yes') || $(this).val().includes('Optional')) ? dockRes.show():
        dockRes.hide()
      //   end
      var selectedOption = $(this).find(':selected');
      var targetClass = selectedOption.data('target');
  ...
  <script>
    $(document).ready(function(){
      ...
      $(document).click(function(){
        ...
        let val = $('select[name="property_type"]').val();
