            ...
            <div class="card" style="overflow: hidden;">
              <div class="card-body pb-2 pt-2">
                ...
                <div class="qr-code" style="width: 50px; height:50px; position: absolute; top:0; right:0;">
                  {{ qr_code(route('seller.agent.auction.detail', @$auction->id), 150) }}
                </div>
                ...
                <span class="d-flex justify-content-between">
                  ...
                  @else
                    <b class="badge bg-info align-self-center ">Active</b>
                  @endif
                </span>
              </div>
              ...
              <div class="card-footer bg-light">
                <div class="row">
                  ...
                  <div class="col-6 right text-end">
                    ...
                    @endphp
                    <b>${{ @$auction->get->custom_seller_specific_price ?: (@$auction->get->otherSellerPrice ?: @$expectation) }}</b>
                  </div>
                </div>
              </div>
