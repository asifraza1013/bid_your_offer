                ...
                <div class="card p-3 mb-3" data-bs-toggle="collapse" data-bs-target="#collapse{{$loop->iteration}}" aria-expanded="true"
                    ...
                    <div class="row myBidsDetails">
                        <div class="col-12 col-md-8 col-lg-8">
                            <div class="fw-bold">{{ $bid->auction->get->service_type }}</div>
                        </div>
                        <div class="col-12 col-lg-4">
                            <div class="fw-bold">{{ ($bid->auction->get->service_type=="Referral agent Service"?"":"$" ). $bid->get->offering_price . ($bid->auction->get->service_type=="Referral agent Service"?"%":"" )}}
                                        ...
                                        <div class="col-12 col-md-6">
                                            <ul class="p-0">
                                                <li>
                                                    ...
                                                    <div class="right"> <a href="{{route('agent.service.auction.view', $bid->auction->id)}}" target="_blank">{{$bid->auction->get->service_type}}</a> </div>
                                                </li>
                                                <li>
                                                    <div class="left">My Bid:</div>
                                                    <div class="right">
                                                        <span>{{ ($bid->auction->get->service_type=="Referral agent Service"?"":"$" ). $bid->get->offering_price . ($bid->auction->get->service_type=="Referral agent Service"?"%":"" )}}</span>
                                                    </div>
                                                </li>
