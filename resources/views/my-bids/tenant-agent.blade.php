...
@section('bids-content')
    <div class="container mt-5 myBid">
        ...
        <div class="accordion" id="accordionExample">
            <!-- Section 2 -->
            @foreach ($bids as $bid)
                <div class="card p-3 mb-3" data-bs-toggle="collapse" data-bs-target="#collapse{{ $loop->iteration }}"
                    aria-expanded="true" aria-controls="collapse{{ $loop->iteration }}">
                    <div class="row myBidsDetails">
                        <div class="col-12 col-md-8 col-lg-8">
                            <div class="fw-bold">{{ $bid->auction->get->title }}</div>
                        </div>
                        <div class="col-12 col-lg-4">
                            <div class="fw-bold">{{ $bid->get->agent_fee }}
                                        ...
                                        <div class="col-12 col-md-6">
                                            <ul class="p-0">
                                                <li>
                                                    ...
                                                    <div class="right"> <a
                                                            href="{{ route('buyer.view-auction', $bid->auction->id) }}"
                                                            target="_blank">{{ $bid->auction->get->title }}</a> </div>
                                                </li>
                                                <li>
