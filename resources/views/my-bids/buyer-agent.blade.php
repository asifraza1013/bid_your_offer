                ...
                <div class="card p-3 mb-3" data-bs-toggle="collapse" data-bs-target="#collapse{{$loop->iteration}}" aria-expanded="true"
                    ...
                    <div class="row myBidsDetails">
                        ...
                        <div class="col-12 col-lg-4">
                            <div class="fw-bold">{{$bid->get->brokerage}}
                                        ...
                                        <div class="col-12 col-md-6">
                                            <ul class="p-0">
                                                <li>
                                                    ...
                                                    <div class="right"> <a href="{{route('buyer.view-auction', $bid->auction->id)}}" target="_blank">{{$bid->auction->get->title}}</a> </div>
                                                </li>
                                                <li>
                                                    <div class="left">My Bid:</div>
                                                    <div class="right">
                                                        <span>{{$bid->get->brokerage}}</span>
                                                    </div>
                                                </li>
