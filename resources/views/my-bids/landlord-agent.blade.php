                ...
                <div class="card p-3 mb-3" data-bs-toggle="collapse" data-bs-target="#collapse{{$loop->iteration}}" aria-expanded="true"
                    ...
                    <div class="row myBidsDetails">
                        ...
                        <div class="col-12 col-lg-4">
                            <div class="fw-bold">{{$bid->get->offering_price}}
                                        ...
                                        <div class="col-12 col-md-6">
                                            <ul class="p-0">
                                                <li>
                                                    ...
                                                    <div class="right"> <a href="{{route('landlord.agent.auction.view', $bid->auction->id)}}" target="_blank">{{$bid->auction->get->address}}</a> </div>
                                                </li>
                                                <li>
