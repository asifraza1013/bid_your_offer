                ...
                <div class="card p-3 mb-3" data-bs-toggle="collapse" data-bs-target="#collapse{{$loop->iteration}}" aria-expanded="true"
                    ...
                    <div class="row myBidsDetails">
                        ...
                        <div class="col-12 col-lg-4">
                            <div class="fw-bold">${{ $bid->auction->bids->max('price') }}
                                ...
                                <div class="p-3 p-md-4 bg-light mb-4">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-6">
                                            <ul class="p-0">
                                                <li>
                                                    <div class="left">Title/Address:</div>
                                                    <div class="right"> <a href="{{route('agent.landlord.auction', $bid->auction->id)}}" target="_blank">{{$bid->auction->address}}</a> </div>
                                                </li>
                                                <li>
                                                    <div class="left">My Bid:</div>
                                                    <div class="right">
                                                        <span>${{number_format($bid->get->offer_rental_price)}}</span>
                                                    </div>
                                                </li>
