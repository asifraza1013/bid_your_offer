      ...
      init: function() {
        ...
        $('.wizard-step-back').click(function(e) {
          if ($('.wizard-step.active').prev().is('.wizard-step')) {
            ...
            if (StepWizard.currentStep == 53 && (property_type == 'Business Opportunity' || property_type ==
                'Commercial Property'))
            {
              StepWizard.backStep = 20;
            }
            else if (StepWizard.currentStep == 9 && property_type == 'Income Property') {
                StepWizard.backStep = 6
                StepWizard.nextStep = 9;
              } 
              ...
              else if (StepWizard.currentStep == 11 && (property_type == 'Commercial Property' ||
                property_type ==
                'Business Opportunity')) {
