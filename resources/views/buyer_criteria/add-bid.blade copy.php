...
<div class="container p-4">
    ...
    <div class="card m-4">
        ...
        <div class="card-body">
            ...
            <form class="p-4 pt-0 mainform" action="{{ route('criteria.auction.bid', @$auction->id) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <input type="hidden" name="auction_id" value="{{ @$auction->id }}">
                @php
                $yes_or_nos = [['name' => 'Yes', 'target' => '', 'icon' => 'fa-regular fa-circle-check'], ['name' => 'No', 'target' => '', 'icon' => 'fa-regular fa-circle-xmark']];
                @endphp
                <div class="wizard-step">Please enter the city, county, and state of the property you are offering to sell.
                    </h4>
                    <div class="form-group">
                        <label class="fw-bold">City:</label>
                        <input type="text" name="city" data-type="cities" placeholder="Florida city, FL, USA" id="city" class="form-control has-icon search_places" data-icon="fa-solid fa-city" data-msg-required="Please enter city" required>
                    </div>

                    <div class="form-group">
                        <label class="fw-bold">County:</label>
                        <input type="text" name="county" data-type="counties" placeholder="Baker County, FL, USA" id="county" class="form-control has-icon search_places" data-icon="fa-solid fa-tree-city" data-msg-required="Please enter county" required>
                    </div>

                    <div class="form-group">
                        <label class="fw-bold">State:</label>
                        <input type="text" name="state" data-type="states" placeholder="Florida, FL, USA" id="states" class="form-control has-icon search_places" data-icon="fa-solid fa-flag-usa" data-msg-required="Please enter state" required>
                    </div>
                </div>
                <div class="wizard-step">
                    ...
                    <div class="form-group">
                        ...
                        <select class="grid-picker" name="property_type" id="property_type" onchange="changePropertyType(this.value);show_property_opt();" required>
                            <option value="">Select</option>
                            @foreach ($property_types as $row_pt)
                            <option value="{{ $row_pt['name'] }}" class="card flex-column fw-bold" style="width:calc(24% - 10px);" data-icon='<i class="fa-solid fa-hotel"></i>'>
                                {{ $row_pt['name'] }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        <div>
                            ...
                            <select name="property_items" id="property_items" class="property_items grid-picker" style="justify-content: flex-start;" multiple required>
                                ...
                                <option value="{{ $item['name'] }}" data-target="" class="card flex-row fw-bold {{ $item['class'] }}" style="width:calc(33.33% - 10px);" data-icon='<i class="fa-regular fa-check-circle"></i>'>
                                    {{ $item['name'] }}
                                </option>
                                @endforeach
                            </select>
            ...
            @endpush --}}
                ...
                <div class="wizard-step">
                    @php
                    $special_sale = [['name' => 'Pre-Construction', 'target' => ''], ['name' => 'Currently Being Built', 'target' => ''], ['name' => 'New Construction', 'target' => ''], ['name' => 'Assignment Contract (Wholesale property)', 'target' => ''], ['name' => 'Bank Owned/REO', 'target' => ''], ['name' => 'Probate Listing', 'target' => ''], ['name' => 'Short Sale', 'target' => ''], ['name' => 'Government Owned', 'target' => ''], ['name' => 'Auction', 'target' => ''], ['name' => 'None', 'target' => '']];
                    @endphp
                    <div class="form-group">
                        <label class="fw-bold">Please select the sale provisions in which the seller is offering: </label>
                        <select class="grid-picker" name="special_sales[]" id="special_sales" multiple style="justify-content: flex-start;" required>
                            <option value="">Select</option>
                            @foreach ($special_sale as $item)
                            <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}" class="card flex-column fw-bold" style="width:calc(25% - 10px);" data-icon='<i class="fa-regular fa-circle-check"></i>'>
                                {{ $item['name'] }}
                            </option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group special_sales d-none">
                        @php
                        $yes_no = [['name' => 'No', 'target' => ''], ['name' => 'Yes', 'target' => '']];
                        @endphp
                        <label>Is the seller currently under contract with a property they would like to
                            assign?</label>
                        <select class="grid-picker" name="special_sales" id="special_sales" style="" required>
                            <option value="">Select</option>
                            @foreach ($yes_no as $item)
                            <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}" class="card flex-column fw-bold" style="width:calc(25% - 10px);" data-icon='<i class="fa-solid fa-bed"></i>'>
                                {{ $item['name'] }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="property_opt">
                        <div class="form-group">
                            ...
                            <select class="grid-picker" name="bedrooms" id="bedrooms" style="" required>
                                ...
                                <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}" class="card flex-column fw-bold" style="width:calc(9% - 10px);" data-icon='<i class="fa-solid fa-bed"></i>'>
                                    {{ $item['name'] }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group custom_bedrooms d-none">
                            ...
                            <input type="text" name="custom_bedrooms" id="custom_bedrooms" class="form-control has-icon" data-icon="fa-solid fa-bed" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="grid-picker" name="bathrooms" id="bathrooms" style="" required>
                                ...
                                <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}" class="card flex-column fw-bold" style="width:calc(10% - 10px);" data-icon='<i class="fa-solid fa-bath"></i>'>
                                    {{ $item['name'] }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group custom_bathrooms d-none">
                            ...
                            <input type="text" name="custom_bathrooms" id="custom_bathrooms" class="form-control has-icon" data-icon="fa-solid fa-bath" required>
                        </div>
                ...
                <div class="wizard-step">
                    <div class="form-group">
                        ...
                        <input type="number" name="min_sqft" id="min_sqft" class="form-control has-icon" data-icon="fa-regular fa-check-circle" required>
                    </div>
                </div>
                <div class="wizard-step">
                    @php
                    ...
                    <div class="form-group">
                        ...
                        <select class="grid-picker" name="flood_insurance" id="flood_insurance" style="justify-content: flex-start;" required>
                            <option value="">Select</option>
                            @foreach ($requires_or_no as $item)
                            <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}" class="card flex-row fw-bold" style="width:calc(33.3% - 10px);" data-icon='<i class="{{ $item['icon'] }}"></i>'>
                                {{ $item['name'] }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group custom_insurance d-none">
                        <label>How much is the flood insurance?</label>
                        <input type="text" name="custom_insurance" id="custom_insurance" class="form-control has-icon" data-icon="fa-solid fa-dollar-sign" required>
                    </div>
                </div>
                <div class="wizard-step">
                    @php
                    $prop_conditions = [['name' => 'Not Updated: Requires a complete update.'], ['name' => 'Tear Down: Requires complete demolition and reconstruction.'], ['name' => 'Semi-updated:Needs minor updates.'], ['name' => 'Completely Updated:No updates needed.']];
                    @endphp
                    <div class="form-group">
                        ...
                        <select class="grid-picker" name="prop_conditions[]" multiple id="prop_conditions" required>
                            ...
                            <option value="{{ $item['name'] }}" class="card flex-row fw-bold" style="width:calc(50% - 10px);" data-icon='<i class="fa-regular fa-check-circle"></i>'>
                                {{ $item['name'] }}
                            </option>
                            @endforeach
                        </select>
                ...
                <div class="wizard-step">
                    <div class="form-group">
                        <label class="fw-bold"> Is the property Currently offered is leased?</label>
                        <select class="grid-picker" name="is_leased" id="is_leased" style="justify-content: flex-start;" required>
                            <option value="">Select</option>
                            ...
                            @endphp
                            <option value="{{ $item['name'] }}" data-target="{{ $target }}" class="card flex-row fw-bold" style="width:calc(33.3% - 10px);" data-icon='<i class="{{ $item['icon'] }}"></i>'>
                                {{ $item['name'] }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="card-body commercial_fields d-none">
                        <div class="row align-items-end">
                            ...
                            <div class="form-group col-md-12">
                                <label>Current Rental Price:</label>

                                <input type="number" name="current_rental_price" placeholder="0.00" class="form-control has-icon" data-icon="fa-solid fa-dollar" required>
                            </div>
                            @php
                            ...
                            @endphp
                            <div class="form-group col-md-12">
                                <label class="text-bold">Current Lease Terms:</label>
                                <select class="grid-picker" name="leased_term" id="leased_term" style="justify-content: flex-start;" multiple required>
                                    <option value="">Select</option>
                                    @foreach ($utilities as $item)
                                    <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}" class="card flex-row fw-bold" style="width:calc(25% - 10px);">
                                        {{ $item['name'] }}
                                    </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group col-md-6">
                                <label for="address">Lease Start Date :</label>
                                <input type="date" name="move_in_date" id="move_in_date" class="form-control has-icon search_places" data-icon="fa-regular fa-calendar-days" data-msg-required="Please enter listing date" required>
                            </div>
                            <div class="form-group col-md-6">
                                <label for="address">Lease Expiration Date:</label>
                                <input type="date" name="lease_expiration_date" id="lease_expiration_date" class="form-control has-icon search_places" data-icon="fa-regular fa-calendar-days" data-msg-required="Please enter listing date" required>
                            </div>
                            <div class="form-group">
                                <label>Security Deposit</label>
                                <input type="number" name="security_deposit" placeholder="0.00" class="form-control has-icon" data-icon="fa-solid fa-dollar" required>
                            </div>
                            <div class="form-group">
                                <label class="fw-bold">Did the tenant pay the last month's rent?</label>
                                <select class="grid-picker" name="is_tenant_pay_rent" id="is_tenant_pay_rent" style="justify-content: flex-start;" required>
                                    <option value="">Select</option>
                            ...
                            <div class="form-group">
                                ...
                                <select class="grid-picker" name="is_tenant_on_rent" id="is_tenant_on_rent" style="justify-content: flex-start;" required>
                                    <option value="">Select</option>
                ...
                <div class="wizard-step">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="max_price" id="max_price" placeholder="" class="form-control has-icon" data-icon="fa-regular fa-check-circle">
                    </div>
                ...
                <div class="wizard-step">
                    ...
                    <div class="form-group">
                        ...
                        <select class="grid-picker" name="financings[]" id="financings" style="justify-content: flex-start;" multiple required>
                            <option value="">Select</option>
                            @foreach ($financings as $item)
                            <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}" class="card flex-row fw-bold" style="width:calc(20% - 10px);">
                                {{ $item['name'] }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group custom_financings d-none">
                        <label>Currency/Financing Type:</label>
                        <input type="text" name="custom_financings" id="custom_financings" class="form-control has-icon" required>
                    </div>
                </div>
                ...
                <div class="wizard-step">
                    <div class="form-group">
                        ...
                        <input type="text" name="escrow_amount_percent" id="escrow_amount_percent" class="form-control has-icon" data-icon="fa-regular fa-check-circle" required>
                    </div>
                </div>
                ...
                <div class="wizard-step">
                    ...
                    <div class="form-group">
                        ...
                        <select class="grid-picker" name="contingencies" id="contingencies" style="" multiple required>
                            ...
                            <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}" class="card flex-column fw-bold" style="width:calc(20% - 10px);" data-icon='<i class="fa-regular fa-check-circle"></i>'>
                                {{ $item['name'] }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group custom_contingencies d-none">
                        ...
                        <input type="text" name="custom_contingencies" id="custom_contingencies" class="form-control has-icon" data-icon="fa-regular fa-check-circle" required>
                    </div>
                </div>
                <div class="wizard-step">
                    <div class="form-group">
                        <label class="fw-bold">What is the commission offered to the buyer’s agent? </label>
                        <input type="number" name="agent_commission_percent" id="agent_commission_percent" placeholder="0.00" step="0.01" class="form-control has-icon" data-icon="fa-solid fa-percent" required>
                    </div>
                ...
                <div class="wizard-step">
                    <div class="form-group">
                        <label class="fw-bold">Description and Additional Details (Please include any additional
                            information. For example, if the home has a pool, garage, waterfront location, recent
                            updates, or any other pertinent information.)</label>
        ...
        <div class="form-group custom_period d-none">
            <label>Inspection Period Offered:</label>
            <input type="text" name="custom_period" id="custom_period" class="form-control has-icon" data-icon="fa-regular fa-check-circle" required>
        </div>
    </div> --}}
...
<div class="wizard-step">
    ...
    <div class="form-group custom_days d-none">
        ...
        <input type="text" name="custom_days" id="custom_days" class="form-control has-icon" data-icon="fa-regular fa-check-circle" required>
    </div>
...
<div class="form-group other_floor_in_property d-none">
    ...
    <input type="text" name="other_floor_in_property" id="other_floor_in_property" placeholder="Floors in property" class="form-control" data-msg-required="Please enter Floors in property" required>
</div>
</div> --}}
...
<div class="card-body commercial_fields " id="no_vaccant">
    <div class="row align-items-end">
        <div class="form-group col-md-6">
            ...
            <input type="number" name="annual_opertaion_expenses" placeholder="0.00" class="form-control has-icon" data-icon="fa-solid fa-dollar" required>
        </div>
        <div class="form-group col-md-6">
            <label>Net Operation Income:</label>

            <input type="number" name="net_operation_income" placeholder="0.00" class="form-control has-icon" data-icon="fa-solid fa-dollar" required>
        </div>
        <div class="form-group col-md-6">
            <label>Captalization Rate:</label>

            <input type="number" name="captalization_rate" placeholder="0.00" class="form-control has-icon" data-icon="fa-solid" required>
        </div>
        @php
        ...
        <div class="form-group col-md-12">
            ...
            <select class="grid-picker" name="sale_includes" id="tenant_pays" style="justify-content: flex-start;" multiple required>
                <option value="">Select</option>
                @foreach ($utilities as $item)
                <option value="{{ $item['name'] }}" data-target="{{ $item['target'] }}" class="card flex-row fw-bold" style="width:calc(25% - 10px);">
                    {{ $item['name'] }}
        ...
        <div class="form-group col-md-6">
            ...
            <input type="number" name="tenant_pays" placeholder="0.00" class="form-control has-icon" data-icon="fa-solid fa-dollar" required>
        </div>
        <div class="form-group col-md-6">
            <label>Landlord Pays:</label>

            <input type="number" name="landlord_pays" placeholder="0.00" class="form-control has-icon" data-icon="fa-solid fa-dollar" required>
        </div>
...
<div class="card-body commercial_fields " id="yes_vaccant">
    <div class="row align-items-end">
        <div class="form-group col-md-6">
            ...
            <input type="number" name="current_operating_expenses" placeholder="0.00" class="form-control has-icon" data-icon="fa-solid fa-dollar" required>
        </div>
        <div class="form-group col-md-6">
            <label> Current Net Operating Income:</label>

            <input type="number" name="current_net_operating_income" placeholder="0.00" class="form-control has-icon" data-icon="fa-solid fa-dollar" required>
        </div>
        <div class="form-group col-md-6">
            <label> Projected Net Operating Income:</label>

            <input type="number" name="projected_net_operating_income" placeholder="0.00" class="form-control has-icon" data-icon="fa-solid fa-dollar" required>
        </div>
        <div class="form-group col-md-6">
            <label> Current Captalization Rate:</label>

            <input type="number" name="current_captalization_rate" placeholder="0.00" class="form-control has-icon" data-icon="fa-solid" required>
        </div>
        <div class="form-group col-md-6">
            <label> Projected Captalization Rate:</label>

            <input type="number" name="projected_captalization_rate" placeholder="0.00" class="form-control has-icon" data-icon="fa-solid" required>
        </div>
        @php
        $utilities = [['name' => 'Building(s) and Land', 'target' => ''], ['name' => 'Furniture/Fixtures', 'target' => ''], ['name' => 'Leases', 'target' => ''], ['name' => 'Other', 'target' => '']];
        @endphp
...
<div class="wizard-step">
    ...
    <div class="form-group">
        ...
        <input type="text" name="address" placeholder="199 Florida A1A, Satellite Beach, FL, USA" id="form_title" class="form-control search_places has-icon" data-type="address" required data-icon="fa-solid fa-location-dot" />
    </div>
    ...
    <div class="form-group">
        ...
        <input type="text" name="property_link" placeholder="" id="property_link" class="form-control has-icon" data-type="address" data-icon="fa-solid fa-link" />
    </div>

    <div class="form-group">
        <label class="fw-bold">Pictures of the property: (link)</label>
        <input type="text" name="floor_plan_link" placeholder="" id="floor_plan_link" class="form-control has-icon" data-type="address" data-icon="fa-solid fa-link" />
    </div>
