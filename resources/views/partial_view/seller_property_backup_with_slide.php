        ...
        <div class="card m-4">
            ...
            <div class="card-body">
                ...
                <form class="p-4 pt-0 mainform" action="{{ route('add-listing') }}" method="POST"
                    ...
                    <div class="wizard-step">
                        @php
                            $service_types = [['name' => 'Full Service', 'target' => ''], ['name' => 'Limited Service', 'target' => '']];
                        @endphp
                        <div class="form-group">
                    ...
                    <div class="wizard-step">
                        ...
                        <div class="form-group">
                            ...
                            <select class="grid-picker" name="special_sale" id="special_sale"
                                style="justify-content: flex-start;" required>
                                <option value="">Select</option>
                    ...
                    <div class="wizard-step">
                        ...
                        <div class="form-group custom_bedrooms d-none">
                            <label class="fw-bold">Bedrooms:</label>
                            <input type="text" name="custom_bedrooms" id="custom_bedrooms"
                    ...
                    <div class="wizard-step">
                        <div class="form-group">
                            ...
                            <select class="grid-picker" name="garage" id="garage"
                                ...
                                @foreach ($yes_or_nos as $item)
                                    ...
                                    @endphp
                                    <option value="{{ $item['name'] }}"
                                        {{ selected($item['name'], @$auction->get->garage) }}
                        ...
                        @php
                            $garage_spaces = [['name' => '1', 'target' => ''], ['name' => '2', 'target' => ''], ['name' => '3', 'target' => ''], ['name' => '4', 'target' => ''], ['name' => '5', 'target' => ''], ['name' => '6', 'target' => ''], ['name' => '7', 'target' => ''], ['name' => '8', 'target' => ''], ['name' => '9', 'target' => ''], ['name' => '10', 'target' => ''], ['name' => 'Other', 'target' => '.custom_garage_spaces']];
                        @endphp
                        <div class="form-group garage_spaces d-none">
                            ...
                            <select class="grid-picker" name="garage_spaces" id="garage_spaces"
                                ...
                                @foreach ($garage_spaces as $item)
                                    <option value="{{ $item['name'] }}"
                                        ...
                                        data-target="{{ $item['target'] }}" class="card flex-row"
                                        style="width:calc(9% - 10px);">
                                        {{ $item['name'] }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group custom_garage_spaces d-none ">
                            <label class="fw-bold">Garage Spaces:</label>
                            <input type="text" name="custom_garage_spaces" id="custom_garage_spaces"
                                class="form-control has-icon" data-icon="fa-solid fa-check-circle" required>
                        </div>
                        <div class="form-group">
                        ...
                        @php
                            $carport_space = [['name' => '1', 'target' => ''], ['name' => '2', 'target' => ''], ['name' => '3', 'target' => ''], ['name' => '4', 'target' => ''], ['name' => '5', 'target' => ''], ['name' => '6', 'target' => ''], ['name' => '7', 'target' => ''], ['name' => '8', 'target' => ''], ['name' => '9', 'target' => ''], ['name' => '10', 'target' => ''], ['name' => 'Other', 'target' => '.custom_carport']];
                        @endphp
                        <div class="form-group carport_space d-none">
                            <label class="fw-bold">Carport Spaces:</label>
                            <select class="grid-picker" name="carport_space" id="carport_space"
                                style="justify-content: flex-start;" required>
                                <option value="">Select</option>
                                @foreach ($carport_space as $item)
                                    <option value="{{ $item['name'] }}"
                        ...
                        <div class="form-group custom_carport  d-none ">
                            <label class="fw-bold">Carport Spaces:</label>
                            <input type="text" name="custom_carport" id="custom_carport"
                                class="form-control has-icon" data-icon="fa-solid fa-check-circle" required>
                        </div>
                        @php
                        ...
                        <div class="form-group">
                            ...
                            <select class="grid-picker" name="pool" id="pool"
                                ...
                                @foreach ($yes_or_nos as $item)
                                    ...
                                    @endphp
                                    <option value="{{ $item['name'] }}"
                                        data-target="{{ $target }}" class="card flex-row"
                                        style="width:calc(33.3% - 10px);"
                                        data-icon='<i class="{{ $item['icon'] }}"></i>'>
                                        {{ $item['name'] }}
                                    </option>
                        ...
                        @php
                            $pool_types = [['target' => '', 'name' => 'Private'], ['target' => '', 'name' => 'Community']];
                        @endphp

                        <div class="form-group pool_types  d-none ">
                            <label class="fw-bold">Pool:</label>
                            <select class="grid-picker" name="pool_types" id="pool_types"
                                style="justify-content: flex-start;" required>
                                <option value="">Select</option>
                                @foreach ($pool_types as $item)
                                    <option value="{{ $item['name'] }}"
                                        data-target="{{ $item['target'] }}" class="card flex-row"
                                        style="width:calc(33.3% - 10px);"
                                        data-icon='<i class="fa-regular fa-check-circle"></i>'>
                    ...
                    <div class="wizard-step vacant_land_remove">
                        ...
                        <div class="form-group">
                            <label class="fw-bold">What is the flood zone code?</label>
                            <input type="text" name="flood_zone_code" id="flood_zone_code" placeholder=""
                    ...
                    <div class="wizard-step business_oportunity_remove">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="front_footage" id="front_footage1" class="form-control has-icon"
                    ...
                    <div class="wizard-step vacant_land_remove">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="taxes_annual_ammount" id="taxes_annual_ammount"
                                class="form-control has-icon" data-icon="fa-solid fa-dollar" placeholder="Taxes(Annual Ammount)"
                                step="0.01" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="zoning" id="zoning" class="form-control has-icon"
                                data-icon="fa-solid ">
                        </div>
                    </div>
                    {{-- 3 Jul 2023 For Business Opportunity --}}
                    ...
                    <div class="wizard-step vacant_land_remove business_oportunity_remove residential_remove">
                        <div class="row">
                            <div class="form-group col-md-4">
                                ...
                                <input type="text" name="unit_type" id="unit_type" placeholder=""
                                    class="form-control has-icon" data-icon="fa-solid">
                            </div>
                            <div class="form-group col-md-4">
                                <label class="fw-bold">Sqt Ft Heated</label>
                                <input type="number" name="sqt_ft_heated" id="sqt_ft_heated" placeholder=""
                                    class="form-control has-icon" data-icon="fa-solid" required>
                            </div>
                            <div class="form-group col-md-4">
                                <label class="fw-bold">Number of Units</label>
                                <input type="number" name="number_of_units" id="number_of_units" placeholder=""
                                    class="form-control has-icon" data-icon="fa-solid" required>
                            </div>
                            <div class="form-group col-md-4">
                                <label class="fw-bold">Occupied</label>
                                <input type="number" name="occupied" id="occupied" placeholder=""
                                    class="form-control has-icon" data-icon="fa-solid" required>
                            </div>
                            <div class="form-group col-md-4">
                                <label class="fw-bold">Expected Rent</label>
                                <input type="number" name="expected_rent" id="expected_rent" placeholder=""
                                    class="form-control has-icon" data-icon="fa-solid" required>
                            </div>
                            <div class="form-group col-md-4">
                                <label class="fw-bold">Garage Spaces</label>
                                <input type="number" name="garage_spaces" id="garage_spaces" placeholder=""
                                    class="form-control has-icon" data-icon="fa-solid" required>
                            </div>
                            <div class="form-group col-md-4">
                                <label class="fw-bold">Garage Attribute</label>
                                <input type="number" name="garage_attribute" id="garage_attribute" placeholder=""
                                    class="form-control has-icon" data-icon="fa-solid" required>
                            </div>
                            <div class="form-group col-md-12">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" name="total_monthly_rent" id="garage_attribute" placeholder=""
                                    class="form-control has-icon" data-icon="fa-solid" required>
                            </div>
                            <div class="form-group col-md-4">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" name="lease_terms" id="garage_attribute" placeholder=""
                                    class="form-control has-icon" data-icon="fa-solid" required>
                            </div>
                            <div class="form-group col-md-4">
                                <label class="fw-bold">Annual Net Income</label>
                                <input type="number" name="annual_net_income" id="garage_attribute" placeholder=""
                                    class="form-control has-icon" data-icon="fa-solid" required>
                            </div>
                            <div class="form-group col-md-4">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="number" name="annual_expenses" id="garage_attribute" placeholder=""
                                    class="form-control has-icon" data-icon="fa-solid" required>
                            </div>
                            @php
                    ...
                    <div class="wizard-step vacant_land_remove business_oportunity_remove">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="minimum_lease_period" id="minimum_lease_period"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="minimum_lease_per_year" id="minimum_lease_period"
                    ...
                    <div class="wizard-step business_oportunity_remove">
                        ...
                        <div class="form-group hoas d-none">
                            ...
                            <input type="number" name="other_fee" id="other_fee" class="form-control has-icon"
                    ...
                    <div class="wizard-step vacant_land_remove residential_and_income_remove">
                        ...
                        <div class="form-group condo_terms row d-none">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="association_contact_name" id="association_contact_name"
                                    class="form-control has-icon" data-icon="fa-regular fa-circle-check" required>
                            </div>
                            <div class="form-group">
                                <label class="fw-bold"> Contact Information </label>
                                <input type="text" name="association_contact_information" id="contact_information"
                                    class="form-control has-icon" data-icon="fa-solid fa-dollar" required>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="wizard-step business_oportunity_remove">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="cost_additional_amenities" id="cost_additional_amenities"
                                class="form-control has-icon" data-icon="fa-solid fa-dollar"
                    ...
                    <div class="wizard-step">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title_company_info" id="title_company_info" placeholder=""
                                class="form-control has-icon" data-icon="fa-solid fa-link">
                        </div>
                        <div class="form-group">
                            <label class="fw-bold">Agent Info</label>
                            <input type="text" name="agent_info" id="agent_info" placeholder=""
                                class="form-control has-icon" data-icon="fa-solid fa-link">
                        </div>
