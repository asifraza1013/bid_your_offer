...
@section('content')
<div class="card">
    {{-- <div class="card-header">Manage Seller Services</div> --}}
    <div class="card-body">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a class="btn btn-primary btn-sm" onclick="editCity(this);" data-action="{{route('admin.sellerServices.update', $county->id)}}" data-name="{{$county->name}}" data-sort="{{$county->sort}}" ><i class="fa-solid fa-pen-to-square"></i> Edit</a>
                        <a class="btn btn-danger btn-sm" onclick="deleteCity(this);" data-action="{{route('admin.sellerServices.destroy', $county->id)}}"><i class="fa-solid fa-trash-can"></i> Delete</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
...
<div class="modal fade" id="addCityModal" tabindex="-1" aria-labelledby="addCityModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <form action="{{route('admin.sellerServices.store')}}" method="POST">
            @csrf
