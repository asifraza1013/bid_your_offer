...
@section('content')
<div class="card">
    {{-- <div class="card-header">Manage Heating Fuels</div> --}}
    <div class="card-body">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a class="btn btn-primary btn-sm" onclick="editRecord(this);" data-action="{{route('admin.heatingFuels.update', $county->id)}}" data-name="{{$county->name}}" ><i class="fa-solid fa-pen-to-square"></i> Edit</a>
                        <a class="btn btn-danger btn-sm" onclick="deleteRecord(this);" data-action="{{route('admin.heatingFuels.destroy', $county->id)}}"><i class="fa-solid fa-trash-can"></i> Delete</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
...
<div class="modal fade" id="addRecordModal" tabindex="-1" aria-labelledby="addRecordModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <form action="{{route('admin.heatingFuels.store')}}" method="POST">
            @csrf
            <div class="modal-header">
            <h5 class="modal-title" id="addRecordModalLabel">Add Heating Fuel</h5>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <form action="" method="POST" class="edit-Record-form">
            ...
            @method('put')
            <div class="modal-header">
            <h5 class="modal-title" id="editRecordModalLabel">Edit Heating Fuel</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="form-group">
