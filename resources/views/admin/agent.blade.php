...
@section('content')
    <div class="card p-4">
        <div class="p-4 text-end">
            <button class="btn btn-success" data-bs-toggle="modal" data-bs-target="#addAdminModal"><i
                    class="fa-solid fa-user-plus"></i> Add New</button>
        </div>
            ...
            <tbody>
                @forelse($users as $user)
                    <tr>
                        ...
                        <td>
                            <a href="#" class="btn btn-edit btn-success btn-sm" data-user="{{ json_encode($user) }}"><i
                                    class="fa-solid fa-user-pen"></i> Edit</a>
                            <a href="{{ route('admin.agent.delete', $user->id) }}"
                                class="btn btn-delete btn-danger btn-sm"><i class="fa-solid fa-user-xmark"></i> Delete</a>
                        </td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="5" class="text-center">
                            <h6>No agent found.</h6>
                        </td>
                    </tr>
                @endforelse
        </table>
            ...
            <div class="modal-content">
                <form action="{{ route('admin.agent') }}" method="POST">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="addAdminModalLabel">Add Agent</h5>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('admin.agent.update') }}" method="POST">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="editAdminModal">Edit Agent</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
