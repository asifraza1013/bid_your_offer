                ...
                @forelse($users as $user)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('admin.buyer.delete', $user->id) }}" class="btn btn-delete btn-danger btn-sm"><i class="fa-solid fa-user-xmark"></i> Delete</a>
                        </td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="5" class="text-center">
                            <h6>No buyer found.</h6>
                        </td>
                    </tr>
                @endforelse
        </table>
...
<div class="modal fade" id="addAdminModal" tabindex="-1" aria-labelledby="addAdminModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <form action="{{route('admin.buyer')}}" method="POST">
            @csrf
            <div class="modal-header">
            <h5 class="modal-title" id="addAdminModalLabel">Add Buyer</h5>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <form action="{{route('admin.buyer.update')}}" method="POST">
            ...
            <div class="modal-header">
            <h5 class="modal-title" id="editAdminModal">Edit Buyer</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="form-group">
