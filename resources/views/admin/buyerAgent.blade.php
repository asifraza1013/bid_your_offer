...
{{-- <div class="mainDashboard">
                    ...
                    <div class="rightCol col-sm-12 col-md-9 col-lg-9">
                        <div class="container mt-5 buyer_buyerAgent">
                            <div class="d-flex justify-content-between align-items-center flex-wrap">
                                <h1>Buyers Agent</h1>
                                <div>
                                    <button data-bs-toggle="modal" data-bs-target="#addBuyerAgent">Add Buyer Agent</button>
                                </div>
                            </div>
                            <div class="card my-4">
                                        ...
                                        <div
                                            ...
                                            <div class="right text-center">
                                                <button class="btn btn-lg" data-bs-toggle="modal"
                                                    data-bs-target="#addBuyerAgent">Edit</button>
                                                <button class="btn btn-lg" data-bs-toggle="modal"
                                                    data-bs-target="#deleteBuyer">Delete</button>
                                            </div>
                                        </div>
                                    </div>
                                    <!-- End  -->
    ...
    <!-- Add Buyer Modal -->
    <div class="modal fade" id="addBuyerAgent" tabindex="-1" aria-labelledby="addBuyerAgentLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="addBuyerAgentLabel">Add New Buyer</h1>
    ...
    <div class="modal fade" id="addBuyerAgent" tabindex="-1" aria-labelledby="addBuyerAgentLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="addBuyerAgentLabel">Edit</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body pb-5">
                    <form>
