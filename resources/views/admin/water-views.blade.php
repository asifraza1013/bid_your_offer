...
@section('content')
<div class="card">
    {{-- <div class="card-header">Manage Water Views</div> --}}
    <div class="card-body">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <a class="btn btn-primary btn-sm" onclick="editCity(this);" data-action="{{route('admin.waterViewTypes.update', $county->id)}}" data-name="{{$county->name}}" ><i class="fa-solid fa-pen-to-square"></i> Edit</a>
                        <a class="btn btn-danger btn-sm" onclick="deleteCity(this);" data-action="{{route('admin.waterViewTypes.destroy', $county->id)}}"><i class="fa-solid fa-trash-can"></i> Delete</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
...
<div class="modal fade" id="addCityModal" tabindex="-1" aria-labelledby="addCityModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <form action="{{route('admin.waterViewTypes.store')}}" method="POST">
            @csrf
            <div class="modal-header">
            <h5 class="modal-title" id="addCityModalLabel">Add Water View</h5>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <form action="" method="POST" class="edit-city-form">
            ...
            @method('put')
            <div class="modal-header">
            <h5 class="modal-title" id="editCityModalLabel">Edit Water View</h5>
            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <div class="form-group">
