                ...
                <div class="card-body pb-2 pt-2">
                    <div style="min-height: 56px;">
                        <h5 class="card-title"><a
                                href="{{ route('agent.service.auction.view', @$auction->id) }}">{{ @$auction->service->name }}</a>
                        </h5>
                    </div>
                ...
                <div class="card-footer bg-light">
                    <div class="row">
                        ...
                        <div class="col-6 right text-end">
                            <b>{{@$auction->min_price_in=="$"?"$":""}}{{ number_format(@$auction->min_price, 0, '', ',') }}{{@$auction->min_price_in=="%"?"%":""}}</b>
                        </div>
                    </div>
                </div>
