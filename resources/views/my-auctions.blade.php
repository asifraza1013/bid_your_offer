            ...
            <div class="rightCol col-sm-12 col-md-8 col-lg-8">
              <div class="container mt-5 myAuctions">
                ...
                <select class="form-select mt-4 mb-3 w-25 auction-type">
                  ...
                  <option value="3" {{ ($type=='3')?"selected":"" }}>Ended/ Sold ({{$soldCount}})</option>
                </select>
                <!-- End  -->
                ...
                <div class="card mb-3 p-3">
                    <div class="row g-0">
                      ...
                      <div class="col-md-8">
                        <div class="card-body">
                          <a href="{{route('view-pl',$pa->id)}}" class="text-dark fs-4 fw-bold ">{{$pa->address}}</a>
                  ...
                  <div class="d-flex justify-content-between buttons flex-wrap">
                    @if($type=="2")
                    <button data-bs-container="body" tabindex="0" data-bs-toggle="popover" data-bs-trigger="hover focus"
                      data-bs-placement="top" data-bs-content="26 views"><svg xmlns="http://www.w3.org/2000/svg"
                      ...
                      @if($type!="4" && $type!="3")
                      <button>
                      <a href="{{route('add-listing')}}?step=1&id={{$pa->id}}&update=1">
                ...
                <div class="modal fade" id="exampleModal_{{$pa->id}}" tabindex="-1" aria-labelledby="exampleModal_{{$pa->id}}Label"
                aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                    <div class="modal-header">
                      <div>
                        <h1 class="modal-title fs-5" id="exampleModal_{{$pa->id}}Label">{{$pa->address}}</h1>
              ...
              <!-- Update modal  -->
              <div class="modal fade" id="updateModal_{{$pa->id}}" tabindex="-1" aria-labelledby="updateModal_{{$pa->id}}Label"
                aria-hidden="true">
                  ...
                  <div class="modal-content upgradeModal position-relative">
                    ...
                    <div class="image">
                      ...
                      <div class="card-body bg-white">
                        <h5 class="text-700 mb-4"><a href="https://bidyouroffer.com/listing/no-timer-6/"
                            target="_blank" class="text-dark">{{$pa->address}}</a></h5>
                        <div class="alert alert-success small"><i class="fa fa-check"></i> Your auction is fully
                          updated.</div>
                      </div>
                    </div>
                  </div>
