        ...
        @forelse ($auctions as $pa)
            <div class="col-sm-6 col-md-4 col-lg-4 mb-3">
                <div class="card" style="overflow: hidden;">
                    ...
                    <img src="{{ url('/auction/images/' . ($pa->firstImage->name ?? 'noimage.png')) }}"
                    ...
                    <div class="card-body pb-2 pt-2">
                        ...
                        @endphp
                        <p class="card-text mb-1"><span class="badge bg-secondary">{{ @$pa->get->property_type }}</span>
                            <span class="float-end"><span><b>MLS ID</b></span>
                                <span>#{{ $pa->mls_id }}</span></span></p>
                    </div>
