        ...
        <div class="card">
            <div class="row">
                <div class="col-12 p-4">
                    <form class="p-4 pt-0 validate mainform" action="{{ route('updateSellerAgentHireAuction') }}" method="POST"
                        ...
                        <div class="container">
                                    ...
                                    <div>
                                        ...
                                        <select name="auction_type" id="auction_type" class="grid-picker"
                                            ...
                                            @foreach ($auction_types as $item)
                                                <option value="{{ $item['name'] }}" {{selected($item['name'], @$auction->get->auction_type)}} data-target="{{ $item['target'] }}"
                                    ...
                                    <div>
                                        ...
                                        <select name="auction_length" id="auction_length" class="auction_length grid-picker"
                                            ...
                                            @foreach ($auction_lengths as $item)
                                                <option value="{{ $item['name'] }}" {{selected($item['name'], @$auction->get->auction_length)}} data-target=""
                                    ...
                                    <select class="grid-picker" name="bedrooms" id="bedrooms"
                                        ...
                                        @foreach ($bedrooms as $bedroom)
                                            <option value="{{ $bedroom['name'] }}"
                                                data-target="{{ $bedroom['target'] }}" {{selected($bedroom['name'], @$auction->get->bedrooms)}} class="card flex-column fw-bold"
                            ...
                            <div class="wizard-step">
                                <div class="form-group">
                                    ...
                                    <select class="grid-picker" name="bathrooms" id="bathrooms"
                                        ...
                                        @foreach ($bathrooms as $bathroom)
                                            <option value="{{ $bathroom['name'] }}"  {{selected($bathroom['name'], @$auction->get->bathrooms)}}
                                ...
                                <div class="form-group custom_bathrooms @if(@$auction->get->custom_bathrooms=="" || @$auction->get->custom_bathrooms=="null") d-none @endif ">
                                    ...
                                    <input type="text" class="form-control has-icon"
                                        ...
                                        data-icon="fa-solid fa-bath" id="custom_bathrooms" required value="{{@$auction->get->custom_bathrooms}}" />
                                </div>
                            </div>
                            ...
                            <div class="wizard-step">
                                ...
                                <div class="form-group custom_listing_terms @if(@$auction->get->custom_listing_terms=="" || @$auction->get->custom_listing_terms=="null") d-none @endif ">
                                    ...
                                    <input type="text" class="form-control has-icon" placeholder="Write Custom Terms"
                                        ...
                                        id="custom_listing_terms" required value="{{@$auction->get->custom_listing_terms}}" />
                                </div>
                            </div>
                            ...
                            <div class="wizard-step">
                                ...
                                <div class="form-group custom_offered_commission @if(@$auction->get->custom_offered_commission=="" || @$auction->get->custom_offered_commission=="null") d-none @endif ">
                                    <label>Write Custom Commission *</label>
                                    <input type="text" class="form-control has-icon"
                                        placeholder="Write Custom Commission" name="custom_offered_commission"
                                        data-icon="fa-regular fa-square-check" id="custom_offered_commission" required value="{{@$auction->get->custom_offered_commission}}" />
                                </div>
                            </div>
                            ...
                            <div class="wizard-step">
                                ...
                                <div class="form-group custom_services @if(@$auction->get->custom_services=="" || @$auction->get->custom_services=="null") d-none @endif ">
                                    ...
                                    <input type="text" class="form-control has-icon"
                                        ...
                                        data-icon="fa-regular fa-hand-point-right" id="custom_services" required value="{{@$auction->get->custom_services}}" />
                                </div>
                            </div>
                            ...
                            <div class="wizard-step">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="preffered_agent" id="preffered_agent"
                                        ...
                                        placeholder="Enter the email address or phone number of the agent that is requested this will allow them to be notified of the auction directly so they can bid to be the Seller’s agent" value="{{@$auction->get->preffered_agent}}">
                                </div>
                            </div>
                            ...
                            <div class="wizard-step cma_questions_">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="cma_q1" id="cma_q1" class="form-control search_places has-icon"
                                        ...
                                        placeholder="County and State included so we can notify agents by county" required value="{{@$auction->get->cma_q1}}">
                                </div>
                            </div>
                            ...
                            <div class="wizard-step cma_questions_">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="cma_q2" id="cma_q2" class="form-control" required value="{{@$auction->get->cma_q2}}">
                                </div>
                            </div>
                            ...
                            <div class="wizard-step cma_questions_">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="cma_q3" id="cma_q3" class="form-control" required  value="{{@$auction->get->cma_q3}}">
                                </div>
                            </div>
                            ...
                            <div class="wizard-step cma_questions_">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="cma_q4" id="cma_q4" class="form-control" required value="{{@$auction->get->cma_q4}}">
                                </div>
                            </div>
                            ...
                            <div class="wizard-step cma_questions_">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="cma_q5" id="cma_q5" class="form-control has-icon"
                                        data-icon="fa-solid fa-link" value="{{@$auction->get->cma_q5}}">
                                </div>
                            </div>
                            ...
                            <div class="wizard-step cma_questions_">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="cma_q6" id="cma_q6" class="form-control has-icon"
                                        data-icon="fa-solid fa-link" value="{{@$auction->get->cma_q6}}">
                                </div>
                            </div>
                            @endif
                                ...
                                <div class="row align-items-start">
                                    ...
                                    <div class="form-group mt-4 col-md-6">
                                        ...
                                        <input type="text" name="sqft" placeholder=""
                                            ...
                                            data-icon="fa-solid fa-pen-ruler" required value="{{@$auction->get->sqft}}" />
                                    </div>
