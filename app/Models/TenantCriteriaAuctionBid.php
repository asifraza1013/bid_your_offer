...
class TenantCriteriaAuctionBid extends Model
{
    use HasFactory;
    ...
    {
        return $this->belongsTo(TenantCriteriaAuction::class, 'tenant_criteria_auction_id', 'id')->withDefault();
    }

    public function meta()
    {
        return $this->hasMany(TenantCriteriaAuctionBidMeta::class);
    }
    ...
    {
        $data = [];
        $metas = TenantCriteriaAuctionBidMeta::where('tenant_criteria_auction_bid_id', $this->id)->get();
