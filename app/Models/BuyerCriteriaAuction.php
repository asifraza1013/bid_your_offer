...
class BuyerCriteriaAuction extends Model
{
    use HasFactory;
    ...
    {
        return $this->hasMany(BuyerCriteriaAuctionBid::class);
    }

    public function meta()
    {
        return $this->hasMany(BuyerCriteriaAuctionMeta::class);
    }
    ...
    {
        $data = [];
        $metas = BuyerCriteriaAuctionMeta::where('buyer_criteria_auction_id', $this->id)->get();
